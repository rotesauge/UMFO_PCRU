...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтаФорма, НастройкиОрганизации, , "ШифроватьДокументы");
...
Процедура Применить(Команда)
	...
	НастройкиОрганизации.Вставить("ШифроватьДокументы"			  ,	?(ШифроватьДокументы, "ДА", "НЕТ"));
	...
	НастройкиОрганизации.Вставить("ПодставлятьКППГрузоотправителя"	, ПодставлятьКППГрузоотправителя);
