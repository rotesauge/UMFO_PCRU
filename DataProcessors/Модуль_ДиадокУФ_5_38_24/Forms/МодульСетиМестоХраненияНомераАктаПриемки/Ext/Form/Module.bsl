...
Функция ФункцииМодуля() Экспорт
	...
	Платформа.ДобавитьФункциюВМанифест(Результат, "ЗаполнитьСтруктуруРаботаСНомеромАкта");
	Платформа.ДобавитьФункциюВМанифест(Результат, "УказатьМестоХраненияРеквизитаНомерАкта");
	Платформа.ДобавитьФункциюВМанифест(Результат, "ЗадатьПараметрыХраненияНомераАктаСпецРеквизит");
	Платформа.ДобавитьФункциюВМанифест(Результат, "ЗадатьПараметрыХраненияНомераАктаДопРеквизит");
