...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Параметры.НоваяВерсия) Тогда
		ПолеНовости = "https://wiki.diadoc.ru/plugins/viewsource/viewpagesrc.action?pageId=12877897";
	Иначе	
...
Процедура СохранитьФайлОбновления()
	...
	Если ДиалогОткрытияФайла.Выбрать() Тогда
		...
		ИмяФайлаОбновления = "Diadoc1C_UF_" + СтрЗаменить(Параметры.НоваяВерсия, ".", "_") + ".epf";
