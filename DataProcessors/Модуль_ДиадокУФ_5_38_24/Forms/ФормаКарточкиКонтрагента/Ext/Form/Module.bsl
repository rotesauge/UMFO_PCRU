...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ПервыйКонтрагентВ1С) Тогда
		...
		ШифроватьДокументы 			= МетодСервера( , "ПолучитьЗначениеСвойства", ПервыйКонтрагентВ1С, "ДиадокШифроватьДокументыКонтрагент");
		НастройкаФорматаОтправки	= МетодСервера( , "ПолучитьЗначениеСвойства", ПервыйКонтрагентВ1С, "ДиадокФормироватьУПДКонтрагент");
...
Процедура УстановитьНастройкиКонтрагентов()
	...
	Для Каждого СтрокаТаблицы ИЗ СписокКонтрагентовВ1С.ПолучитьЭлементы() Цикл
		...
		Если ЗначениеЗаполнено(СтрокаТаблицы.КонтрагентВ1С) Тогда
			...
			МетодСервера(, "УстановитьЗначениеСвойства", СтрокаТаблицы.КонтрагентВ1С, "ДиадокШифроватьДокументыКонтрагент", , ШифроватьДокументы);
