...
&НаСервере
		Процедура ДобавитьВложенныйФайлКОтраженномуДокументуНаСервере()
			// Вставить содержимое обработчика.
		КонецПроцедуры

&НаКлиенте
		Процедура ДобавитьВложенныйФайлКОтраженномуДокументу(Команда)
			ДобавитьВложенныйФайлКОтраженномуДокументуНаСервере();
		КонецПроцедуры
