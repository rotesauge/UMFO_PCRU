...
Процедура ОбновитьСписокДокументов()
	...
	ПараметрыПМ.Вставить("DocumentType", 		Параметры.Type);
	ПараметрыПМ.Вставить("DocumentFunction",	Параметры.Function);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Режим = "Сопоставление" Тогда
		...
		ИначеЕсли Параметры.Type = "XmlTorg12" ИЛИ Параметры.Type = "XmlAcceptanceCertificate" 
		  ИЛИ (Параметры.Type = "UniversalTransferDocument"
		  И (Параметры.Function = МетодСервера(, "ТипДокументаУПД", "ДОП") ИЛИ Параметры.Function = МетодСервера(, "ТипДокументаУПД", "СЧФДОП"))) Тогда 
	...
	Если Параметры.Режим = "Сопоставление" Тогда
		...
		ИначеЕсли Параметры.Type = "XmlTorg12" ИЛИ Параметры.Type = "XmlAcceptanceCertificate" 
		  ИЛИ (Параметры.Type = "UniversalTransferDocument" И Параметры.Function = МетодКлиента("Модуль_Клиент", "ТипДокументаУПД", "ДОП")) Тогда
			...
			Закрыть(Параметры);
		ИначеЕсли Параметры.Type = "UniversalTransferDocument" И Параметры.Function = МетодКлиента("Модуль_Клиент", "ТипДокументаУПД", "СЧФДОП") Тогда
