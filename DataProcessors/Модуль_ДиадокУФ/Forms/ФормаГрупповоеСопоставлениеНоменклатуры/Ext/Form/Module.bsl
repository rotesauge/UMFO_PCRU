...
Процедура НачатьСозданиеНоменклатурыИнформационнойБазы(ЭлементСопоставления)
	...
	Если ФормаНоменклатуры <> Неопределено Тогда
		...
		Если ЭтоУНФ() Тогда
			ЕстьРеквизитШаблоныНаименованийКэш = МетодКлиента("Модуль_Клиент", "ЕстьРеквизитИлиСвойствоОбъекта", ФормаНоменклатуры, "ШаблоныНаименованийКэш") = Истина;
			Если ЕстьРеквизитШаблоныНаименованийКэш Тогда
				ФормаНоменклатуры.ШаблоныНаименованийКэш.Очистить();
			КонецЕсли;
		КонецЕсли;
