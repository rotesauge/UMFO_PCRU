...
//{ Управление формой
	...
	Процедура ОграничитьТипПоляВнешняяПечатнаяФорма()
		...
		ДопустимыеТипыВПФ = Новый Массив();
		ДопустимыеТипыВПФ.Добавить(Тип("СправочникСсылка.ДополнительныеОтчетыИОбработки"));
		
		ОписаниеТиповВПФ = Новый ОписаниеТипов(ДопустимыеТипыВПФ);
		
		Элементы.ВнешняяПечатнаяФорма.ОграничениеТипа = ОписаниеТиповВПФ;
