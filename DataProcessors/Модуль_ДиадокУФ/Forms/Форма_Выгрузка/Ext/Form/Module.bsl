...
//{ УПРАВЛЕНИЕ ФОРМОЙ
	...
	Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
		...
		Параметры.Свойство("ЕстьНастройкаОтправкиВУстаревшемФормате", ЕстьНастройкаОтправкиВУстаревшемФормате);
...
//{ КОМАНДЫ
	...
	Процедура ПоказатьИнструкцию_ЕслиНеВижуДокумент(Команда)
		...
		НазваниеДействия = "Инструкция не вижу документ";
		
		Метрики_ДобавитьПоведение_НажатиеКнопки(НазваниеДействия);
		Метрики_ДобавитьСтатистику(НазваниеДействия);
