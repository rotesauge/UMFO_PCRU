...
&НаКлиенте
Перем НомерИтерацииВызоваМодуля Экспорт;
...
Функция ФункцииМодуля() Экспорт
	...
	Платформа.ДобавитьФункциюВМанифест(Результат, "ПредставлениеПодписи");
	...
	Платформа.ДобавитьФункциюВМанифест(Результат, "ФильтрыДокументовПоТипу");
	Платформа.ДобавитьФункциюВМанифест(Результат, "ФункцииЭлектронныхДокументов");
	Платформа.ДобавитьФункциюВМанифест(Результат, "ЭтоАгентскаяФункцияУПДУКД");
	...
	Платформа.ДобавитьФункциюВМанифест(Результат, "ТочкиВызоваУниверсальныхФорм");
	Платформа.ДобавитьФункциюВМанифест(Результат, "РежиПроксиКомпонентыВРежимПроксиМодуля");
	Платформа.ДобавитьФункциюВМанифест(Результат, "ДоступныеТипыЗапросовВКомпоненте");
	Платформа.ДобавитьФункциюВМанифест(Результат, "ТипПодписантаДляКонтента");
	Платформа.ДобавитьФункциюВМанифест(Результат, "ПодписантИП");
	Платформа.ДобавитьФункциюВМанифест(Результат, "Перечисление_SignerType");
	Платформа.ДобавитьФункциюВМанифест(Результат, "Перечисление_ТипыОтветногоДействия");
	Платформа.ДобавитьФункциюВМанифест(Результат, "ПараметрыОтветныхДействий");
	...
	Платформа.ДобавитьФункциюВМанифест(Результат, "ЕстьРеквизитИлиСвойствоОбъекта");
	...
	Платформа.ДобавитьФункциюВМанифест(Результат, "Метрики_ПредставлениеBoxId");
	// }Метрики
	...
	Платформа.ДобавитьФункциюВМанифест(Результат, "СопоставленныеКонтрагенты");
	...
	Платформа.ДобавитьФункциюВМанифест(Результат, "УведомленияПользователей_СписокУведомлений"); 
	
	Платформа.ДобавитьФункциюВМанифест(Результат, "Kontur_API_GetPortalBills");
	Платформа.ДобавитьФункциюВМанифест(Результат, "Kontur_API_GetPortalBillsContent");
	Платформа.ДобавитьФункциюВМанифест(Результат, "ИдентификаторЛицевогоСчетаДиадок");
	Платформа.ДобавитьФункциюВМанифест(Результат, "ЕстьОнлайнСчетаНаОплату");
	
	Платформа.ДобавитьФункциюВМанифест(Результат, "ДоменПользователяКонтур");
	Платформа.ДобавитьФункциюВМанифест(Результат, "ДоменПользователяКонтурПовтИсп", , "НаВремяСеанса");
		
	Платформа.ДобавитьФункциюВМанифест(Результат, "ОтключеноАвтоматическоеОбновлениеМодуля");
	Платформа.ДобавитьФункциюВМанифест(Результат, "Перечисление_МестоположенияМодуля");
	
	// Машиночитаемые доверенности
	Платформа.ДобавитьФункциюВМанифест(Результат, "МЧД_УстановитьЗначениеПризнакаПоУмолчанию");
	Платформа.ДобавитьФункциюВМанифест(Результат, "Документы_СобытияМЧД_HTML");
	Платформа.ДобавитьФункциюВМанифест(Результат, "МЧД_ДанныеПоИспользованиюДоверенностей");
	Платформа.ДобавитьФункциюВМанифест(Результат, "МЧД_БыстраяПроверка");
	Платформа.ДобавитьФункциюВМанифест(Результат, "МЧД_СписокДоверенностей");
	Платформа.ДобавитьФункциюВМанифест(Результат, "МЧД_ТребуетсяДоверенность");
    Платформа.ДобавитьФункциюВМанифест(Результат, "МЧД_ДанныеПоИспользованиюДоверенностейПоСпискуBoxId");
	Платформа.ДобавитьФункциюВМанифест(Результат, "МЧД_ПараметрыФормыВыбора");
	Платформа.ДобавитьФункциюВМанифест(Результат, "ДействияНаФормеВопросаМЧД");
	Платформа.ДобавитьФункциюВМанифест(Результат, "МЧД_ДляВыполненияДействияТребуетсяМЧДпоУмолчанию");
	Платформа.ДобавитьФункциюВМанифест(Результат, "МЧД_КонтрактМЧДДляГрупповыхДействий");
	Платформа.ДобавитьФункциюВМанифест(Результат, "МЧД_ВыполнитьПроверкиДоверенностиПоУмолчаниюПередОтправкойДокументов");
...
//
&НаКлиенте
Процедура ПоказатьПредупреждениеОбУстаревшихНастройкахОтправки(ВладелецФормыСообщения, ИмяОбработчика = Неопределено, ДобавитьИнструкцию = Ложь) Экспорт
...
// Открывает служебную форму с информационным сообщением об автоматической смене устаревших настроек отправки.
//
// Параметры:
//  ВладелецФормыСообщения - УправляемаяФорма - форма, из которой открывается предупреждение
//  ИмяОбработчика - Строка - имя экспортной процедуры-обаботчика оповещения о закрытии формы предупреждения
//  УстревшиеНастройки - Структура - см. метод сервера ОрганизацииИКонтрагентыСУтаревшимиНастройкамиОтправки()
//
&НаКлиенте
Процедура ПоказатьСообщениеОбАвтоматическомОбновленииНастроекОтправки(ВладелецФормыСообщения, ИмяОбработчика = Неопределено, УстревшиеНастройки) Экспорт
	
	ОрганизацииИБ = СвойствоСтруктуры(УстревшиеНастройки,"ОрганизацииИБ", Новый Массив);
	Метрика_ДобавитьСтатистику_УведомлениеОСменеФормата(ОрганизацииИБ);
	
	ДобавитьИнструкцию = Истина;
	ТекстСообщения = ТекстСообщенияАвтообновленияУстаревшегоФормата(ДобавитьИнструкцию);
	ЗаголовокСообщения = ЗаголовокПредпрежденияОбУстаревшемФормате();
...
&НаКлиенте
Процедура ОткрытьФормуУведомлениеНетМЧД(ВладелецФормыСообщения, СписокОшибокМЧД, BoxIDДляФормыНастроек) Экспорт
	
	ТекстСообщения = МЧД_HTMLТекст_ТекстУведомленияПослеПроверкиМЧДПоУмолчанию(СписокОшибокМЧД, BoxIDДляФормыНастроек);
	ЗаголовокСообщения = "Настройка доверенности";
...
//	результат метода помещается в клиентский кэш
//
&НаКлиенте
Функция ДоменПользователяКонтурПовтИсп() Экспорт
...
#Область АвтообновлениеМодуля

#Область СборДанныхДляОбновления

// Дополняет набор параметров, необходимый для:
//	- оценки возможности автообновления,
// 	- выполнения автообновления,
//	- уведомления пользователя об автообновлении.
//	Первичное заполнение выполняется в методе ДанныеДляОбновленияМодуля()
//
// Параметры:
//	ДанныеДляОбновленияМодуля - Структура - см. метод НовыеДанныеДляОбновленияМодуля()
//
&НаКлиенте
Процедура ДополнитьДанныеДляОбновленияМодуля(ДанныеДляОбновленияМодуля) Экспорт
	
	РасположениеМодуля = ДанныеДляОбновленияМодуля.РасположениеМодуля;
	ОписаниеОбновления = ДанныеДляОбновленияМодуля.ОписаниеОбновленияМодуля;
	ОписаниеОкруженияМодуля = ДанныеДляОбновленияМодуля.ОписаниеОкруженияМодуля;
	
	ЗаполнитьОписаниеОбновленияМодуля(ДанныеДляОбновленияМодуля);
	Если Не ОписаниеОбновления.ЕстьНоваяВерсия Тогда
		Возврат;
	КонецЕсли;
	
	Если ДанныеДляОбновленияМодуля.МодульЗапущенВпервые 
		 Или ДанныеДляОбновленияМодуля.МодульБылОбновлен
		 Или Не ДанныеДляОбновленияМодуля.МожноОбновитьМодуль Тогда
		Возврат;
	КонецЕсли;
	
	МестоположенияМодуля = Перечисление_МестоположенияМодуля();
	
	Если РасположениеМодуля.Местоположение = МестоположенияМодуля.ФайлНаДиске Тогда
		ТекстОшибки = ПроверитьВозможностьОбновленияФайлаМодуля(РасположениеМодуля.ПутьКФайлу);
	...
	Если ОтключеноАвтоматическоеОбновлениеМодуля() Тогда
		ДанныеДляОбновленияМодуля.МожноОбновитьМодуль = Ложь;
		ДанныеДляОбновленияМодуля.КомментарийМодуля = "ОтключеноАвтообновление";
		Возврат;
	КонецЕсли;
...
Функция Перечисление_МестоположенияМодуля() Экспорт
	...
	Результат = МетодСервера(, "Перечисление_МестоположенияМодуля");
	
	Возврат Результат;
	
КонецФункции

// Определяет невозможность автоматического обновления модуля
//	на основании соответствующей настройки модуля или через анализ окружения
// 
// Возвращаемое значение:
//  Булево - Истина, если автообновление отключено.
//
&НаКлиенте
Функция ОтключеноАвтоматическоеОбновлениеМодуля() Экспорт
	...
	ЗначениеНастройки = МетодСервера(, "ЗначениеНастройкиОтключитьАвтоматическоеОбновлениеМодуля");
	НастройкаУстановлена = ( ТипЗнч(ЗначениеНастройки) = Тип("Булево") );
	
	Если НастройкаУстановлена Тогда
		Результат = ЗначениеНастройки;
		Возврат Результат; 
	КонецЕсли;
	
	МодульЗапущенДляРазработкиИлиТестирования = ДоменПользователяКонтур();
	Если МодульЗапущенДляРазработкиИлиТестирования Тогда
		Результат = Истина;
	КонецЕсли;
...
// Скачивает новую версию файла модуля из сервиса обновлений
// и записывает его на диск или в справочник внешних обработок
//
// Параметры:
//  ДанныеДляОбновленияМодуля - Структура - см. функцию НовыеДанныеДляОбновленияМодуля();
//
&НаКлиенте
Процедура ВыполнитьОбновлениеМодуля(ДанныеДляОбновленияМодуля) Экспорт
	...
	Если Местоположение = МестоположенияМодуля.ФайлНаДиске Тогда
		...
		ВыполнитьОбновлениеМодуляВФайлеНаДиске(ПутьКФайлу, ОписаниеОбновления);
		
	ИначеЕсли Местоположение = МестоположенияМодуля.ЭлементСправочника Тогда
		
		ВыполнитьОбновлениеМодуляВСправочнике(ВнешняяОбработка, ОписаниеОбновления);
	...
	Метрика_ЗарегистрироватьУспешноеАвтообновлениеМодуля(ДанныеДляОбновленияМодуля);
...
Процедура ЗарегистрироватьОшибкуАвтообновленияМодуляВЖурналеРегистрации(ОписаниеОшибки) Экспорт
	...
	КатегорияСобытия = НСтр("ru = 'Автообновление'; en = 'Autoupdate'");
		
	ИмяСобытия = Событие + "." + КатегорияСобытия;
	ПредставлениеУровня = "Ошибка";
	Комментарий = ОписаниеОшибки;
	ДатаСобытия = ТекущаяДата();
	
	ЖурналРегистрацииКлиент.ДобавитьСообщениеДляЖурналаРегистрации(ИмяСобытия, ПредставлениеУровня, Комментарий, ДатаСобытия);
...
&НаКлиенте
Функция МЧД_УстановитьЗначениеПризнакаПоУмолчанию(BoxId, КонтрактМЧД) Экспорт
	...
	Для Каждого EmployeePowerOfAttorney Из EmployeePowerOfAttorney_Collection Цикл
		...
		Если PowerOfAttorney.Id.RegistrationNumber = КонтрактМЧД.Идентификатор Тогда 
			...
			Organization.MyEmployee.SetDefaultPowerOfAttorney(PowerOfAttorney);
			Результат = Истина;
...
&НаКлиенте
Функция Документы_СобытияМЧД(ЭДОбъект)
	
	ТаблицаСобытийМЧД	= Новый Массив;
	УровниКритичности	= УровниКритичностиСтатусаДокумента();

	AttachedPowerOfAttorney_Коллекция = ЭДОбъект.GetPowersOfAttorney();
	
	Для Каждого AttachedPowerOfAttorney Из AttachedPowerOfAttorney_Коллекция Цикл
		
		Событие = МЧД_НоваяСтрокаСобытий(ТаблицаСобытийМЧД);
		
		Событие.Дата		= AttachedPowerOfAttorney.Date;
		Событие.Описание	= МЧД_ОписаниеСобытия(AttachedPowerOfAttorney.Affiliation);
		
		Контракт_МЧД = Новый_Контракт_МЧД();
		МЧД_ЗаполнитьКонтракт(Контракт_МЧД, AttachedPowerOfAttorney.PowerOfAttorney);
		Событие.ИнформацияОДоверенности	= Контракт_МЧД;

		СтатусМЧД = AttachedPowerOfAttorney.Status;
		
		Если СтатусМЧД <> Неопределено Тогда
			
			ОписанияПроверокМЧД				= Новый Массив;
			Событие.ЕстьОшибкаПроверкиМЧД	= СтатусМЧД.Severity = УровниКритичности.Error;
			
			Если Событие.ЕстьОшибкаПроверкиМЧД Тогда

				Для Каждого ErrorCode Из СтатусМЧД.Errors Цикл
				
					ОписанияПроверокМЧД.Добавить(ErrorCode.Text);
				
				КонецЦикла;
				
			КонецЕсли;
			
			Если ОписанияПроверокМЧД.Количество() = 0 Тогда
				
				ОписанияПроверокМЧД.Добавить(СтатусМЧД.Text);
				
			КонецЕсли;
			
			Событие.ОписанияПроверокМЧД = ОписанияПроверокМЧД;
			
		КонецЕсли;

	КонецЦикла;
	
	Возврат ТаблицаСобытийМЧД;
	
КонецФункции

&НаКлиенте
Функция МЧД_ОписаниеСобытия(Affiliation)
	
	Результат = "";
	
	ТипВложения = Перечисление_PowerOfAttorneyAffiliation();
	
	Если Не ТипВложения.Свойство(Affiliation, Результат) Тогда
		
		Результат = "Неопознанный тип";
...
&НаКлиенте
Функция МЧД_НоваяСтрокаСобытий(СписокМЧД)
	
	Результат = Новый Структура;
	Результат.Вставить("EntityId"					, "");
	Результат.Вставить("MessageId"					, "");
	Результат.Вставить("RawCreationDate"			, "");
	Результат.Вставить("AttachmentType"				, ""); 
	Результат.Вставить("Дата"						, Дата(1,1,1));
	Результат.Вставить("BoxId"						, "");
	Результат.Вставить("ИнформацияОДоверенности"	, Неопределено);
	Результат.Вставить("Описание"					, "");
	Результат.Вставить("ЕстьОшибкаПроверкиМЧД"		, Ложь);
	Результат.Вставить("ОписанияПроверокМЧД"		, Новый Массив);
	
	СписокМЧД.Добавить(Результат);
...
&НаКлиенте
Функция МЧД_НовыйРезультатБыстройПроверки()
	
	Результат = Новый Структура;
	Результат.Вставить("ЭтоДействующаяМЧД"		, Ложь);
	Результат.Вставить("РасшифровкаСтатуса"		, "");
	Результат.Вставить("КритичностьСтатуса"		, "");
	Результат.Вставить("ИдентификаторСтатуса"	, "");
...
&НаКлиенте
Функция Документы_СобытияМЧД_HTML(ЭДОбъект) Экспорт 
	
	ТаблицаСобытийМЧД = Документы_СобытияМЧД(ЭДОбъект);
	...
	ШаблонСобытияHTML = "<tr id=""%6"">
	| <td id=""col1"">
	|    <div class=""organization"">%1</div>
	|    <div>%2</div>
	...
	|</tr>
	|";
	ШаблонСобытияПроверкиHTML = "<p style=""margin-bottom: -4%; text-align: left;"">%1<p>";
	
	ТелоHTML = "";
	
	Для Каждого Событие Из ТаблицаСобытийМЧД Цикл
		
		ИнформацияОДоверенности = Событие.ИнформацияОДоверенности;
		
		ДоверительПредставитель = "" 
		+ ИнформацияОДоверенности.Доверитель.Наименование
		+ ", "
		+ ИнформацияОДоверенности.Представитель.Наименование;
		
		СрокДействия = "До " + Формат(ИнформацияОДоверенности.СрокДействия, "ДФ=dd.MM.yyyy");
		
		ОписаниеДействия = Событие.Описание;
		Если ЗначениеЗаполнено(ОписаниеДействия) И ЗначениеЗаполнено(Событие.Дата) Тогда
			
			ПредставлениеДаты = Формат(Событие.Дата, "ДФ='dd.MM.yy ""в"" ЧЧ:мм'");
			ОписаниеДействия = ОписаниеДействия + " "+ ПредставлениеДаты;
			
		КонецЕсли;
		
		СтильСтрокиТаблицы		 = "";
		СтильНаписиПроверкиМЧД	 = "";
		Если Событие.ЕстьОшибкаПроверкиМЧД Тогда
			СтильСтрокиТаблицы		 = "trerror";
			СтильНаписиПроверкиМЧД	 = "error";
		КонецЕсли;  
		
		ОписанияПроверокМЧДСтрокой = "";
		
		Если ЗначениеЗаполнено(Событие.ОписанияПроверокМЧД) Тогда
			
			Дефис = ?(Событие.ЕстьОшибкаПроверкиМЧД, "- ", "");
			Для каждого ОписаниеПроверокиМЧД Из Событие.ОписанияПроверокМЧД Цикл
				ОписанияПроверокМЧДСтрокой = ОписанияПроверокМЧДСтрокой + ПодставитьПараметрыВСтроку(ШаблонСобытияПроверкиHTML, Дефис + ОписаниеПроверокиМЧД);
			КонецЦикла;
			
		КонецЕсли;
		
		СобытиеHTML = ПодставитьПараметрыВСтроку(	ШаблонСобытияHTML,
														ДоверительПредставитель,
														СрокДействия,
														ОписаниеДействия,
														СтильНаписиПроверкиМЧД,
	...
	Результат = ПодставитьПараметрыВСтроку(ТекстHTML, ТелоHTML);
...
&НаКлиенте
Процедура МЧД_ЗаполнитьКонтракт(КонтрактМЧД, PowerOfAttorney)
		
	Если PowerOfAttorney = Неопределено Тогда
		Возврат;
	КонецЕсли;
		
	КонтрактМЧД.Идентификатор		= PowerOfAttorney.Id.RegistrationNumber;
	КонтрактМЧД.ДатаНачалаДействия	= PowerOfAttorney.BeginDate;
	КонтрактМЧД.СрокДействия		= PowerOfAttorney.EndDate;
	
	Issuer 		= PowerOfAttorney.Issuer;
	Доверитель 	= КонтрактМЧД.Доверитель;
	
	Доверитель.Наименование	= Issuer.Name;
	Доверитель.ИНН			= Issuer.INN;
	Доверитель.КПП			= Issuer.KPP;
			
	Confidant	= PowerOfAttorney.Confidant;
	Если Confidant <> Неопределено Тогда 
		
		Представитель	= КонтрактМЧД.Представитель;
		
		Представитель.Наименование	= Confidant.Name;
		Представитель.ИНН			= Confidant.INN;
		
	КонецЕсли;	

	КонтрактМЧД.ПредставлениеМЧД	= Представление_МЧД(КонтрактМЧД);
	
КонецПроцедуры

&НаКлиенте
Функция Новый_Контракт_МЧД()
	...
	СтатусПроверки.Вставить("ДатаОтзыва"	, '00010101');
...
&НаКлиенте
Функция Перечисление_ТипВложения()
	
	// https://api-docs.diadoc.ru/ru/latest/proto/Entity%20message.html
...
&НаКлиенте
Функция Перечисление_PowerOfAttorneyAffiliation()
	
	Результат = Новый Структура;
	
	Результат.Вставить("ForRevocationRejection"			, "Использовалась при отказе в аннулировании");
	Результат.Вставить("ForDocumentRejection"			, "Использовалась при отказе в подписи");
	Результат.Вставить("ForReceipt"						, "Использовалась при подписании извещения о получении");
	Результат.Вставить("ForCorrectionRequest"			, "Использовалась при запросе уточнения");
	Результат.Вставить("ForRevocation"					, "Использовалась при аннулировании");
	Результат.Вставить("ForDocumentSignature"			, "Использовалась при подписании документа");
	Результат.Вставить("ForSignatureRequestRejection"	, "Использовалась при отказе в подписи");
...
&НаКлиенте
Функция МЧД_ДанныеПоИспользованиюДоверенностей(АдресЯщика, ВыполнитьПроверкуМЧДпоУмолчанию = Ложь) Экспорт
	
	КонтекстМЧД = Новый_КонтекстСпискаМЧД();
	
	Если АдресЯщика <> Неопределено Тогда
		
		КонтекстМЧД.ТребуетсяМЧД = МЧД_ТребуетсяДоверенность(АдресЯщика);
		
		Если КонтекстМЧД.ТребуетсяМЧД Тогда
			
			КонтекстМЧД.СписокМЧД = МЧД_СписокДоверенностей(АдресЯщика);
			
			Для Каждого МЧД Из КонтекстМЧД.СписокМЧД Цикл
				
				КонтрактМЧД = МЧД.Значение;
				
				Если КонтрактМЧД.ПоУмолчанию Тогда
					
					КонтекстМЧД.МЧД = КонтрактМЧД.Идентификатор;
					
					Если ВыполнитьПроверкуМЧДпоУмолчанию Тогда
						КонтекстМЧД.РезультатПроверкиМЧД = МЧД_БыстраяПроверка(КонтрактМЧД, АдресЯщика);
					КонецЕсли;
	...
	Возврат Новый ФиксированнаяСтруктура(КонтекстМЧД);
	
КонецФункции

&НаКлиенте
Функция МЧД_ДанныеПоИспользованиюДоверенностейПоСпискуBoxId(АдресаЯщиков) Экспорт
	
	Результат = Новый Соответствие;
	
	Для Каждого АдресЯщика Из АдресаЯщиков Цикл
		КонтекстСпискаМЧД = МЧД_ДанныеПоИспользованиюДоверенностей(АдресЯщика, Истина);
		Результат.Вставить(АдресЯщика, КонтекстСпискаМЧД);
	КонецЦикла;
...
&НаКлиенте
Функция Новый_КонтекстСпискаМЧД() Экспорт
...
&НаКлиенте
Функция МЧД_ТребуетсяДоверенность(АдресЯщика) Экспорт
	
	Результат = МетодКлиента("Модуль_РаботаССерверомДиадок", "ДанныеКонтекстаДиадок", АдресЯщика, "ТребуетсяМЧД") = Истина;
...
&НаКлиенте
Функция МЧД_СписокДоверенностей(АдресЯщика, ТолькоДействующие = Истина) Экспорт

	Доверенности = Новый Соответствие;
	
	EmployeePowersOfAttorney = GetEmployeePowersOfAttorney(АдресЯщика, ТолькоДействующие);
	
	Для Каждого Контракт_МЧД Из EmployeePowersOfAttorney Цикл

		Доверенности.Вставить(Контракт_МЧД.Идентификатор, Контракт_МЧД);

	КонецЦикла;
	
	Результат = Новый ФиксированноеСоответствие(Доверенности);
...
&НаКлиенте
Функция МЧД_БыстраяПроверка(КонтрактМЧД, АдресЯщика) Экспорт
	
	Результат			= МЧД_НовыйРезультатБыстройПроверки();
	УровниКритичности	= УровниКритичностиСтатусаДокумента();
	
	Connection		= Платформа.ПараметрыКлиент.КонтекстРаботаССерверомДиадок.DiadocConnection;
	Organization	= Connection.GetOrganizationById(АдресЯщика);
	
	EmployeePowerOfAttorney_Collection	= Organization.MyEmployee.GetPowersOfAttorney(Ложь);
	
	Для Каждого EmployeePowerOfAttorney Из EmployeePowerOfAttorney_Collection Цикл 
		
		PowerOfAttorney	= EmployeePowerOfAttorney.PowerOfAttorney;
		
		Если КонтрактМЧД.Идентификатор = PowerOfAttorney.Id.RegistrationNumber Тогда 
			
			СтатусМЧД = EmployeePowerOfAttorney.Prevalidation.Status;
			
			Если СтатусМЧД <> Неопределено Тогда
				
				Результат.ЭтоДействующаяМЧД		= СтатусМЧД.Severity <> УровниКритичности.Error;
				Результат.РасшифровкаСтатуса	= СтатусМЧД.Text;
				Результат.КритичностьСтатуса	= СтатусМЧД.Severity;
				Результат.ИдентификаторСтатуса	= СтатусМЧД.Id;
				
				Если Не Результат.ЭтоДействующаяМЧД Тогда
					
					Для Каждого ErrorCode Из СтатусМЧД.Errors Цикл 
						
						Результат.СписокОшибок.Добавить(ErrorCode.Text);
...
&НаКлиенте
Функция GetEmployeePowersOfAttorney(АдресЯщика, ТолькоДействующие)
	
	Контракты_МЧД = Новый Массив;
	
	Connection		= Платформа.ПараметрыКлиент.КонтекстРаботаССерверомДиадок.DiadocConnection;
	Organization	= Connection.GetOrganizationById(АдресЯщика);
	
	EmployeePowerOfAttorney_Collection	= Organization.MyEmployee.GetPowersOfAttorney(ТолькоДействующие);
	
	Для Каждого EmployeePowerOfAttorney Из EmployeePowerOfAttorney_Collection Цикл 
		
		КонтрактМЧД		= Новый_Контракт_МЧД();
		PowerOfAttorney	= EmployeePowerOfAttorney.PowerOfAttorney;
		
		МЧД_ЗаполнитьКонтракт(КонтрактМЧД, PowerOfAttorney);
		
		КонтрактМЧД.ПоУмолчанию	= EmployeePowerOfAttorney.IsDefault;
		
		Status	= EmployeePowerOfAttorney.Prevalidation.Status;
		Если Status <> Неопределено Тогда 
			
			СтатусПроверки	= КонтрактМЧД.СтатусПроверки;
			
			СтатусПроверки.Статус	= Status.Severity;
			
		КонецЕсли;
		
		Контракты_МЧД.Добавить(КонтрактМЧД);
		
	КонецЦикла;
	
	Возврат Контракты_МЧД;
...
#Область МЧД_СлужебныйПрограммныйИнтерфейс

&НаКлиенте
Процедура ПроверитьМЧДИВыполнитьОповещение(ОповещениеЗавершения, ВыбраннаяМЧД, АдресЯщика, ДействиеЭДО) Экспорт
	
	ДействияНаФормеВопросаМЧД = ДействияНаФормеВопросаМЧД();
	ДополнительныеПараметры = Новый Структура;
	ДополнительныеПараметры.Вставить("ВыбраннаяМЧД"			, ВыбраннаяМЧД);
	ДополнительныеПараметры.Вставить("ОповещениеЗавершения"	, ОповещениеЗавершения);
	
	ОбработчикПослеПроверкиМЧД = Новый ОписаниеОповещения("ОбработчикПослеПроверкиМЧД", ЭтотОбъект, ДополнительныеПараметры);
	
	ТребуетсяМЧД = МЧД_ТребуетсяДоверенность(АдресЯщика); 
	Если ТребуетсяМЧД Тогда
		
		Если НЕ ЗначениеЗаполнено(ВыбраннаяМЧД) Тогда
			ПоказатьВопрос_НеВыбранаМЧД(ОбработчикПослеПроверкиМЧД, ДействиеЭДО); 
			
		Иначе
			
			РезультатБыстройПроверкиМЧД = МЧД_БыстраяПроверка(ВыбраннаяМЧД, АдресЯщика);
			
			Если НЕ РезультатБыстройПроверкиМЧД.ЭтоДействующаяМЧД Тогда
				
				ОбработчикПослеПроверкиМЧД.ДополнительныеПараметры.ВыбраннаяМЧД = Неопределено;
				ПоказатьВопрос_ВыбраннаяМЧДНеПодходит(ОбработчикПослеПроверкиМЧД, РезультатБыстройПроверкиМЧД, ВыбраннаяМЧД.ПредставлениеМЧД); 
				
			Иначе
				
				ВыполнитьОбработкуОповещения(ОбработчикПослеПроверкиМЧД, ДействияНаФормеВопросаМЧД.ПродолжитьСМЧД);
	...
	Иначе
		...
		ОбработчикПослеПроверкиМЧД.ДополнительныеПараметры.ВыбраннаяМЧД = Неопределено;
		ВыполнитьОбработкуОповещения(ОбработчикПослеПроверкиМЧД, ДействияНаФормеВопросаМЧД.ПродолжитьБезМЧД);
...
&НаКлиенте
Процедура ОбработчикПослеПроверкиМЧД(ВыбранноеДействие, ДополнительныеПараметры) Экспорт
	
	ДействияНаФормеВопросаМЧД = ДействияНаФормеВопросаМЧД();
	
	Если ВыбранноеДействие = ДействияНаФормеВопросаМЧД.ПродолжитьБезМЧД
		ИЛИ ВыбранноеДействие = ДействияНаФормеВопросаМЧД.ПродолжитьСМЧД Тогда
		Результат = РезультатВыбораМЧД(Истина, ДополнительныеПараметры.ВыбраннаяМЧД);
	Иначе
		Результат = РезультатВыбораМЧД(Ложь);
	КонецЕсли;
...
&НаКлиенте
Функция РезультатВыбораМЧД(РазрешитьДействие, КонтрактМЧД = Неопределено) Экспорт
...
&НаКлиенте
Функция АдресаЯщиковОбрабатываемыхДанным(ВыделенныеСтроки)

	КэшЯщиков = Новый Соответствие;
	
	Для Каждого СтрокаСписка Из ВыделенныеСтроки Цикл
		
		Организация1С = СтрокаСписка.Организация;
		
		Если КэшЯщиков.Получить(Организация1С) = Неопределено Тогда
			КонтекстЯщика = МетодКлиента("Модуль_РаботаССерверомДиадок", "СтрокаКонтекста", Организация1С);
			КэшЯщиков.Вставить(Организация1С, КонтекстЯщика.BoxId);
		КонецЕсли;
		
	КонецЦикла;
	
	Результат = Новый Массив;
	Для Каждого ЭлементКэша Из КэшЯщиков Цикл
		Результат.Добавить(ЭлементКэша.Значение);
	КонецЦикла;
...
&НаКлиенте
Функция МЧД_ВыполнитьПроверкиДоверенностиПоУмолчаниюПередОтправкойДокументов(ДанныеДляОбработки) Экспорт
	
	СгруппированныеДанные	 = МЧД_СгруппироватьДанныеДляОбработкиПоИдентификаторуЯщика(ДанныеДляОбработки);
	ИдентификаторыЯщиков	 = ВыгрузитьКолонку(СгруппированныеДанные, "Ключ", Истина);
	КонекстыДанныхМЧД 		 = МЧД_ДанныеПоИспользованиюДоверенностейПоСпискуBoxId(ИдентификаторыЯщиков);
	...
	Для Каждого ИдентификаторЯщика Из ИдентификаторыЯщиков Цикл
		...
		Если ЗначениеЗаполнено(КонтекстМЧД.МЧД) Тогда
			...
			Если НЕ РезультатПроверкиМЧД.ЭтоДействующаяМЧД Тогда
				...
				ОписаниеОшибки = МЧД_НовыйОписаниеОшибкиПроверкиМЧДпоУмолчанию(
					РазделыОшибок.МЧДнеПодходит,
					РезультатПроверкиМЧД.РасшифровкаСтатуса,
		...
		Иначе
			...
			НаименованиеОрганизации = МетодКлиента("Модуль_РаботаССерверомДиадок", "ДанныеКонтекстаДиадок", ИдентификаторЯщика, "Организация");
		...
		ДокументыСЭтимИдентификатором = СгруппированныеДанные.Получить(ИдентификаторЯщика);
		ДополнитьДокументыСведениямиОбМЧД(ДокументыСЭтимИдентификатором, КонтрактМЧД);
...
&НаКлиенте
Функция МЧД_НовыйОписаниеОшибкиПроверкиМЧДпоУмолчанию(Раздел, РасшифровкаСтатуса, СписокОшибок)
...
&НаКлиенте
Функция МЧД_СгруппироватьДанныеДляОбработкиПоИдентификаторуЯщика(ДанныеДляОбработки)
	...
	Если ЗначениеЗаполнено(ДанныеДляОбработки) Тогда
		...
		ЕстьПолеBoxId = ЕстьРеквизитИлиСвойствоОбъекта(ДанныеДляОбработки[0], "BoxId");
		
		Для каждого СтрокаСписка Из ДанныеДляОбработки Цикл
			
			Если ЕстьПолеBoxId Тогда
				BoxId				 = СтрокаСписка.BoxId; 
			Иначе 
				Организация1С		 = СтрокаСписка.Организация;
				BoxId				 = КэшЯщиков.Получить(Организация1С);
				Если BoxId = Неопределено Тогда
					КонтекстЯщика	 = МетодКлиента("Модуль_РаботаССерверомДиадок", "СтрокаКонтекста", Организация1С);
					BoxId			 = КонтекстЯщика.BoxId;
					КэшЯщиков.Вставить(Организация1С, BoxId);
				КонецЕсли;
			КонецЕсли;
			...
			ДанныеПоBoxId.Добавить(СтрокаСписка);
...
// 
// Параметры:
//    Документы		 - Структура - ДокументДД, см. Модуль_Ядро.Контракт_Документ().
//    КонтрактМЧД	 - Структура - см. Модуль_Ядро.Контракт_МЧД().
// 
&НаКлиенте
Процедура ДополнитьДокументыСведениямиОбМЧД(ДанныеДляОбработки, КонтрактМЧД) Экспорт
	
	Для Каждого СтрокаСписка Из ДанныеДляОбработки Цикл 
		СтрокаСписка.КонтрактМЧД = КонтрактМЧД;
	КонецЦикла;
...
#Область МЧД_СлужебныеПроцедурыИФункции
...
&НаКлиенте
Функция МЧД_СписокОшибокВТекстHTML(ОшибкиПроверокМЧД)
	
	Шаблоны	= МЧД_ШаблоныHTMLДокументаОшибокПроверки();
	...
	Если ОшибкиПоРазделам.Получить(РазделыОшибок.НетМЧДПоУмолчанию) <> Неопределено Тогда
		СписокОшибокСтрокой = СтрСоединить(ОшибкиПоРазделам[РазделыОшибок.НетМЧДПоУмолчанию], Символы.ПС);
		ТекстРаздела = СтрШаблон(Шаблоны.НетМЧДПоУмолчанию, РазделыОшибок.НетМЧДПоУмолчанию, СписокОшибокСтрокой);	
		ЭлементыДокументаHTML.Добавить(ТекстРаздела);
	КонецЕсли;
	
	Если ОшибкиПоРазделам.Получить(РазделыОшибок.МЧДнеПодходит) <> Неопределено Тогда
		СписокОшибокСтрокой = СтрСоединить(ОшибкиПоРазделам[РазделыОшибок.МЧДнеПодходит], Символы.ПС);
		ТекстРаздела = СтрШаблон(Шаблоны.МЧДнеПодходит, РазделыОшибок.МЧДнеПодходит, СписокОшибокСтрокой);	
		ЭлементыДокументаHTML.Добавить(ТекстРаздела);
	КонецЕсли;
	
	ЭлементыДокументаHTML.Добавить(Шаблоны.Окончание);
	
	Результат = СтрСоединить(ЭлементыДокументаHTML, Символы.ПС);
...
Функция МЧД_РасшифровкаОшибокВСтрокуСпискаHTML(Заголовок, СписокОшибок)
	...
	Для Каждого ОписаниеОшибок Из СписокОшибок Цикл
		ТекстСтрокиСпискаHTML = СтрШаблон(ШаблонСтрокиСпискаHTML, ОписаниеОшибок);
		ЭлементыСпискаHTML.Добавить(ТекстСтрокиСпискаHTML);		
	КонецЦикла;
	
	ТекстСпискаHTML = СтрСоединить(ЭлементыСпискаHTML, Символы.ПС);
	...
	Результат = СтрШаблон(ШаблонСпискаHTML, Заголовок, ТекстСпискаHTML);
...
Функция МЧД_РасшифровкаСтатусаВСтрокуСпискаHTML(Текст)
	...
	Результат = СтрШаблон(ШаблонСтрокиСпискаHTML, Текст);
...
&НаКлиенте
Функция МЧД_ШаблоныHTMLДокументаОшибокПроверки()
	...
	|		%2
	|	</ul>
	|<p class=""footer"">Чтобы настроить МЧД, перейдите в раздел ""Настройки""-""Доверенности"" или выполните действие без доверенности</p>
	|<br/>";
	...
	|		%2
	|	</ul>
	|<p class=""footer"">Проверьте данные в разделе ""Настройки""-""Доверенности"" или выполните действие без доверенности.</p>
	|<br/>";
...
&НаКлиенте
Функция МЧД_РазделыОшибокПроверкиМЧД()
...
#Область МЧД_ВызовФормИДиалоговыхОкон

&НаКлиенте
Процедура ОткрытьФормуВыбораДоверенности(ОписаниеОповещения, ПараметрыОткрытияФормы, ФормаВызова = Неопределено) Экспорт

	Если ФормаВызова = Неопределено Тогда
		ФормаВызова = ЭтаФорма;
	КонецЕсли;
	
	МетодКлиента(, "ОткрытьФормуОбработкиМодально",
		"ФормаВыбораМашиночитаемойДоверенности",
...
&НаКлиенте
Процедура ОткрытьФормуСпискаДоверенностей(АдресТекущегоЯщика, ФормаВызова) Экспорт

	ПараметрыОткрытияФормы = Новый Структура;
	ПараметрыОткрытияФормы.Вставить("АдресЯщика", АдресТекущегоЯщика);
...
&НаКлиенте
Функция МЧД_ПараметрыФормыВыбора(ЗаголовокФормы = "", ЗаголовокКнопки = "", АдресЯщика = "", ДействиеЭДО = "") Экспорт

	Результат = Новый Структура;
	Результат.Вставить("ЗаголовокФормы"			, ЗаголовокФормы);
	Результат.Вставить("ЗаголовокКнопкиДействия", ЗаголовокКнопки);
	Результат.Вставить("АдресЯщика"				, АдресЯщика);
...
&НаКлиенте
Процедура ПоказатьВопрос_НеВыбранаМЧД(Оповещение, ДействиеЭДО)
	...
	ШаблонВопроса = 
	"С 1 марта 2022 года при работе с электронными документами нужно подтверждать действия машиночитаемой доверенностью (МЧД). До начала 2023 года доверенность можно не прикладывать.
	|
	|%1 или %2 без доверенности.";
	
	ТекстВариантаДействия1 = "Выберите МЧД";
	
	ДействияЭДО = Перечисление_ТипыОтветногоДействия();
	
	Если ДействиеЭДО = ДействияЭДО.ОтказВПодписиДокумента Тогда
		ТекстВариантаДействия2 = "сформируйте отказ в подписи документа";
	ИначеЕсли ДействиеЭДО = ДействияЭДО.ЗапроcНаАннулированиеДокумента
		ИЛИ ДействиеЭДО = ДействияЭДО.ПринятиеАннулированияДокумента Тогда
		ТекстВариантаДействия2 = "аннулируйте документ";
	ИначеЕсли ДействиеЭДО = ДействияЭДО.ОтказОтАннулированияДокумента Тогда
		ТекстВариантаДействия2 = "сформируйте отказ";
	ИначеЕсли ДействиеЭДО = ДействияЭДО.ЗапроcНаУточнениеДокумента Тогда
		ТекстВариантаДействия2 = "сформируйте запрос на уточнение";
	Иначе
		ТекстВариантаДействия2 = "подпишите документ";	
	КонецЕсли;
	
	ТекстВопроса = СтрШаблон(ШаблонВопроса, ТекстВариантаДействия1, ТекстВариантаДействия2);

	ПоказатьВопрос(Оповещение, ТекстВопроса, КнопкиВопроса, , ДействияНаФормеВопросаМЧД.Закрыть, "Не выбрана доверенность");

КонецПроцедуры

&НаКлиенте
Процедура ПоказатьВопрос_ВыбраннаяМЧДНеПодходит(Оповещение, РезультатПроверкиМЧД, ПредставлениеМЧД)
	...
	СтрокиСообщенияРезультатаПроверки = Новый Массив;
	
	СтрокаРасшифровки = Новый ФорматированнаяСтрока(РезультатПроверкиМЧД.РасшифровкаСтатуса, Новый Шрифт(,12));
	СтрокиСообщенияРезультатаПроверки.Добавить(СтрокаРасшифровки);
	
	СписокОшибок = РезультатПроверкиМЧД.СписокОшибок;
	Для Каждого ОписаниеОшибки Из СписокОшибок Цикл
		СтрокиСообщенияРезультатаПроверки.Добавить(Символы.ПС + "  - " + ОписаниеОшибки);
	КонецЦикла;
	ТекстСообщенияРезультатаПроверки = Новый ФорматированнаяСтрока(СтрокиСообщенияРезультатаПроверки);
	
	ТекстВопроса = СтрШаблон(ШаблонВопроса, ПредставлениеМЧД, ТекстСообщенияРезультатаПроверки);
	
	ПоказатьВопрос(Оповещение, ТекстВопроса, КнопкиВопроса, , ДействияНаФормеВопросаМЧД.Закрыть , "Выбранная доверенность не подходит");
	
КонецПроцедуры

&НаКлиенте
Процедура МЧД_ПоказатьВопросНетПодходящейДоверенности(ДополнительныеПараметры) Экспорт
	...
	ТекстВопроса = 
	"С 1 марта 2022 года при работе с электронными документами нужно подтверждать действия "+
	"с машиночитаемой доверенностью (МЧД). До начала 2023 года доверенность можно не прикладывать.
	|"+"
	|При выполнении действия с доверенностями произошли ошибки. Перейдите по кнопке"+
	"""Подробнее"" для просмотра причин.";
	
	ОбработчикВопроса = Новый ОписаниеОповещения("ОбработатьДействияНаФормеВопросаНетПодходящейМЧД", ЭтотОбъект, ДополнительныеПараметры);
	
	ПоказатьВопрос(ОбработчикВопроса, ТекстВопроса, КнопкиВопроса, , ДействияНаФормеВопросаМЧД.Закрыть , "Нет подходящих доверенностей");

КонецПроцедуры

&НаКлиенте
Процедура ОткрытьФормуОшибокПроверокМЧД(ОшибкиПроверокМЧД, ФормаВызова, ОписаниеОповещенияЗакрытияФормы = Неопределено) Экспорт
	
	ТекстHTML = МЧД_СписокОшибокВТекстHTML(ОшибкиПроверокМЧД);
	
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("ЗаголовокФормы", НСтр("ru = 'Нет подходящей доверенности'"));
	ПараметрыФормы.Вставить("HTMLДокумент"	, ТекстHTML);
	
	ИмяОбработчикаЗакрытия 	= ОписаниеОповещенияЗакрытияФормы.ИмяПроцедуры;
	ДополнительныеПараметры = ОписаниеОповещенияЗакрытияФормы.ДополнительныеПараметры;
	МодульОбработчика 		= ОписаниеОповещенияЗакрытияФормы.Модуль;
	
	МетодКлиента( , "ОткрытьФормуОбработкиМодально",
		"ФормаВыводаHTMLДокумента",
		ПараметрыФормы,
		ФормаВызова,
		ИмяОбработчикаЗакрытия,
...
// Возвращаемое значение:
//	Строка
Функция МЧД_HTMLТекст_ТекстУведомленияПослеПроверкиМЧДПоУмолчанию(СписокОшибокМЧД, BoxIDДляФормыНастроек)
	...
	СсылкаМЧДНастроить				 = ПараметрыОповещенияВСтрокуHTMLСообщения("ОбработчикОткрытьФормуНастроекМЧД", BoxIDДляФормыНастроек, Истина);
	СсылкаМЧДЗагрузитьВВебе			 = АдресаИнтернетРесурсов.МЧДЗагрузитьВВебе;
	
	Картинки						 = ЭДО_БиблиотекаКартинок();
	КартинкаСинийПлюс				 = Base64Строка(Картинки.КартинкаСинийПлюс.ПолучитьДвоичныеДанные());
	КартинкаСиняяШестеренка			 = Base64Строка(Картинки.КартинкаСиняяШестеренка.ПолучитьДвоичныеДанные());
	КартинкаСиняяСтрелкаВверх		 = Base64Строка(Картинки.КартинкаСиняяСтрелкаВверх.ПолучитьДвоичныеДанные());
	СимволСтрелкаВправо				 = Символ(8594);
	
	ТелоHTML = СтрЗаменить(ТелоHTML, "<p>", "<p> ");
	...
	Подстрока = "<p class=strtext2 style=""margin-top: 1%;"">С 01 января 2022 г. вступает в силу пункт 14 статьи 1 ФЗ от 27.12.2019 № 476-ФЗ, в соответствии с которым сотрудники ЮЛ/ИП для подтверждения полномочий должны использовать машиночитаемую доверенность. </p>
	|<p class=strtext2><b>Машиночитаемая доверенность (МЧД)</b> - доверенность, созданная в электронной форме и подписанная электронной подписью представителя ЮЛ/ИП. </p>
	|<p class=strtext2><A href=""" + СсылкаМЧДПодробнееОбИзменениях + """>Подробнее об изменениях</A></p>
	|<p class=strtext style=""margin-top: 4%;"">Выберите действие: </p>
	|<p class=strtext2> <IMG src=""data:image/png;base64," + КартинкаСинийПлюс + """> <A href=""" + СсылкаМЧДВыпуститьНовую + """>Выпустить новую МЧД</A> <a class=setting>(если у вас еще нет МЧД)</a></p>
	|<p class=strtext2> <IMG src=""data:image/png;base64," + КартинкаСиняяШестеренка + """> <A href=""" + СсылкаМЧДНастроить + """>Настроить МЧД в модуле</A></p>
	|<p class=strtext2> <IMG src=""data:image/png;base64," + КартинкаСиняяСтрелкаВверх + """> <A href=""" + СсылкаМЧДЗагрузитьВВебе + """>Загрузить МЧД в веб-версии Диадока</A> <a class=setting>(в разделе ""Настройки "+ СимволСтрелкаВправо +" Сотрудники"")</a></p>
	|";
	
	ПодстрокиТела.Добавить(Подстрока);
	
	ТекстТела = СтрСоединить(ПодстрокиТела, Символы.ПС);
...
#Область МЧД_ГрупповыеДействия

&НаКлиенте
Процедура МЧД_ПроверитьДоверенностьПоУмолчаниюИВыполнитьОповещение(ОписаниеОповещения) Экспорт

	ПараметрыОбработки 	= ОписаниеОповещения.ДополнительныеПараметры;
	ДанныеДляОбработки	= ПараметрыОбработки.ДанныеДляОбработки;

    ОшибкиПроверокМЧД = МетодКлиента("Модуль_Клиент", "МЧД_ВыполнитьПроверкиДоверенностиПоУмолчаниюПередОтправкойДокументов", ДанныеДляОбработки);
	Если ОшибкиПроверокМЧД.Количество() Тогда
		
		ДополнительныеПараметры = Новый Структура;
		ДополнительныеПараметры.Вставить("ОписаниеОповещения"	, ОписаниеОповещения);
		ДополнительныеПараметры.Вставить("ОшибкиПроверокМЧД"	, ОшибкиПроверокМЧД);
		
		НомерИтерацииВызоваМодуля = НомерИтерацииВызоваМодуля + 1;
	
		МетодКлиента("Модуль_Клиент", "МЧД_ПоказатьВопросНетПодходящейДоверенности", ДополнительныеПараметры);
...
&НаКлиенте
Процедура ОбработатьДействияНаФормеВопросаНетПодходящейМЧД(ВыбранноеДействие, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли ВыбранноеДействие = ДействияНаФормеВопросаМЧД.ОткрытьСписокОшибок Тогда
		
		ОбработчикЗакрытия = Новый ОписаниеОповещения("МЧД_ОбработатьЗакрытиеФормыHTMLСообщения", ЭтотОбъект, ДополнительныеПараметры);
		
		НомерИтерацииВызоваМодуля = НомерИтерацииВызоваМодуля + 1;
		
		МетодКлиента("Модуль_Клиент", "ОткрытьФормуОшибокПроверокМЧД",ДополнительныеПараметры.ОшибкиПроверокМЧД, ДополнительныеПараметры.ОписаниеОповещения.Модуль, ОбработчикЗакрытия);
...
&НаКлиенте
Процедура МЧД_ОбработатьЗакрытиеФормыHTMLСообщения(Результат, ДополнительныеПараметры) Экспорт
	
	МЧД_ПоказатьВопросНетПодходящейДоверенности(ДополнительныеПараметры);
	
КонецПроцедуры


&НаКлиенте
Функция МЧД_ДляВыполненияДействияТребуетсяМЧДпоУмолчанию(ResolutionRequestType) Экспорт
	
	Возврат (ResolutionRequestType = Неопределено);
	
КонецФункции

&НаКлиенте
Процедура МЧД_ИнициализироватьКэшКонтекстов() Экспорт

	Если КэшКонтекстовМЧД = Неопределено Тогда
		КэшКонтекстовМЧД = Новый Соответствие;
	Иначе
		КэшКонтекстовМЧД.Очистить();
	КонецЕсли;

КонецПроцедуры

&НаКлиенте
Функция МЧД_КонтрактМЧДДляГрупповыхДействий(АдресЯщика) Экспорт
	
	Если КэшКонтекстовМЧД = Неопределено Тогда
		МЧД_ИнициализироватьКэшКонтекстов();
	КонецЕсли;
	
	Результат = Неопределено;
	
	КонтекстМЧД = КэшКонтекстовМЧД.Получить(АдресЯщика);

	Если КонтекстМЧД = Неопределено Тогда
		
		СоединениеСДиадок 	= МетодКлиента("Модуль_РаботаССерверомДиадок", "ДанныеКонтекстаДиадок", АдресЯщика, "Connection");
		КонтекстМЧД 		= МЧД_ДанныеПоИспользованиюДоверенностей(АдресЯщика, Истина);
		
		КэшКонтекстовМЧД.Вставить(АдресЯщика, КонтекстМЧД);
		
	КонецЕсли;
	
	ЭтоДействующаяМЧД = СвойствоСтруктуры(КонтекстМЧД.РезультатПроверкиМЧД, "ЭтоДействующаяМЧД", Ложь);
	
	Если КонтекстМЧД.ТребуетсяМЧД И ЗначениеЗаполнено(КонтекстМЧД.МЧД) И ЭтоДействующаяМЧД Тогда
		Результат = КонтекстМЧД.СписокМЧД.Получить(КонтекстМЧД.МЧД);
	КонецЕсли;
...
Процедура ПроверитьКонтентПередОтражениемВУчете(ПротоКонтент, Отказ)
	...
	ФункцияДокумента = СвойствоСтруктуры(ПротоКонтент.Контент, "Function");
	ЭтоАгентскаяФункцияУПДУКД = ЭтоАгентскаяФункцияУПДУКД(ФункцияДокумента);
	...
	ИначеЕсли ЭтоАгентскаяФункцияУПДУКД Тогда
		
		ТекстСообщения = НСтр("ru = 'Отражение в учете данного документа не поддерживается!'");
		ПоказатьПредупреждение(, ТекстСообщения, 60);
		Отказ = Истина;
...
Функция ТекстПредпрежденияОбУстаревшемФормате(ДобавитьИнструкцию = Ложь)
	...
	СсылкаНаПриказ736	= АдресаРесурсов.ПриказОбУтвержденииФормата736;
	СсылкаНаИнструкцию	= АдресаРесурсов.Инструкция_ПараметрыОтправки;
	...
	ТекстСообщения =
		...
		|<BODY>
		|<P>Вы отправляете корректировочные документы в старом формате, который перестанет действовать 1 октября 2021 года.</P>
		|<P>Смените настройки формата документов по <A href=""" + СсылкаНаИнструкцию + """>инструкции</A>. Выберите формат отправки по <A href=""" + СсылкаНаПриказ736 + """> Приказу ФНС № 736</A>.</P>";
...
&НаКлиенте
Функция ТекстСообщенияАвтообновленияУстаревшегоФормата(ДобавитьИнструкцию = Ложь)
	
	АдресаРесурсов		= АдресаИнтернетРесурсов();
	СсылкаНаПриказ736	= АдресаРесурсов.ПриказОбУтвержденииФормата736;
	СсылкаНаПриказ189	= АдресаРесурсов.ПриказОбУтвержденииФормата189;
	...
	ТекстСообщения =
		...
		|<STYLE type=""text/css"">h3{margin-top:0.5em; margin-bottom:1em;} p{margin-top:0.2em; margin-bottom:1em;}</STYLE></HEAD>
		|<BODY>
		|<P>С 1 октября 2021 года корректировочные документы можно выставлять только в новом формате по <A href=""" + СсылкаНаПриказ736 + """> Приказу ФНС № 736</A>. <A href=""" + СсылкаНаПриказ189 + """>Приказ № 189</A> перестанет действовать.</P> 
		|В модуле настройки изменены автоматически: все ваши документы отправляются в новом формате.";
	...
	Если ДобавитьИнструкцию Тогда 
		...
		|<P>Вы можете изменить формат самостоятельно по <A href=""" + СсылкаИнструкцияПараметрыОтправки + """>инструкции.</A></P>";
...
Функция ЗаголовокПредпрежденияОбУстаревшемФормате()
	...
	Возврат НСтр("ru = 'Смена формата корректировочных документов'");
...
КонецФункции
	...
	Функция ПредставлениеСтатусаСогласования(Document) Экспорт
		...
		ИначеЕсли СтатусСогласования = "ActionsRequested" И Document.Resolutions.Count > 0 Тогда
			Результат = "Ожидается действие по маршруту";
		Иначе
			Результат = "";
		КонецЕсли;
	...
	Функция ДоменПользователяКонтур()
		...
		// Вызов через МетодКлиента для использования клиентского кэша
		Возврат МетодКлиента("Модуль_Клиент", "ДоменПользователяКонтурПовтИсп");
	...
	&НаКлиенте
	Функция ПредставлениеПодписи(АдресЯщика) Экспорт
		
		ФИОПодписанта 			= МетодКлиента("Модуль_РаботаССерверомДиадок", "ПолучитьФИОПодписанта", АдресЯщика);
		НаименованиеОрганизации = МетодКлиента("Модуль_РаботаССерверомДиадок", "ДанныеКонтекстаДиадок", АдресЯщика, "Организация");
		
		Подстроки = Новый Массив;
		Подстроки.Добавить(НаименованиеОрганизации);
...
// Получает список хеш-сумм всех релизных модулей
//
// Возвращаемое значение:
//  Строка
//
&НаКлиенте
Функция ХешСуммыВсехТиповыхМодулей()
	
	ПараметрыСервиса = ОбщиеПараметрыHTTPСервиса();
	ПараметрыЗапроса = НовыеПараметрыHTTPЗапроса();
	
	СтруктураURI = СтруктураURI(АдресаИнтернетРесурсов().СтраницаФайловВнешнейКомпоненты);
	ПараметрыСервиса.АдресВебСервиса = СтруктураURI.ИмяСервера;
...
// Получает описание новой версии модуля из сервиса обновлений
//
// Параметры:
//  ТекущаяВерсия 			- Строка 	- версия модуля, для которой нужно найти обновление
//	ОписаниеОкруженияМодуля	- Структура	- см. функциию ОписаниеОкруженияМодуля()
// 
// Возвращаемое значение:
//	Структура - содержит свойства:
//   * status		- Число		- код выполнения запроса;
//   * links		- Массив	- ссылки на новую версию модуля и другой контент;
//	 * description	- Строка	- описание новой версии;
//
&НаКлиенте
Функция ОписаниеНовойВерсииИзСервисаОбновлений(ТекущаяВерсияМодуля, ОписаниеОкруженияМодуля)
	
	ПараметрыСервиса = ОбщиеПараметрыHTTPСервиса();
	ПараметрыЗапроса = НовыеПараметрыHTTPЗапроса();
	
	СервисОбновлений = АдресаИнтернетРесурсов().СервисОбновлений;
	
	СтруктураURI = СтруктураURI(СервисОбновлений);
	ПараметрыСервиса.АдресВебСервиса = СтруктураURI.ИмяСервера;
	
	ПараметрыТелаЗапроса = ПараметрыТелаЗапросаОписанияНовойВерсии(ТекущаяВерсияМодуля, ОписаниеОкруженияМодуля);
	
	ПараметрыЗапроса.Метод = "POST";
	ПараметрыЗапроса.АдресМетода = "/1c/v3/diadoc_uf/check";
	ПараметрыЗапроса.ТелоЗапроса = ЗначениеВСтрокуJSON(ПараметрыТелаЗапроса);
...
&НаКлиенте
Функция ПараметрыТелаЗапросаОписанияНовойВерсии(ВерсияМодуля, ОписаниеОкруженияМодуля)
	
	Результат = Новый Структура;
	
	ТестоваяУстановка = ДоменПользователяКонтур();
	BaseId = Объект.ПараметрыКлиентСервер.ИдентификаторБазы;
			
	// client
	Результат.Вставить("client_id", BaseId);
	Результат.Вставить("client_is_test", ТестоваяУстановка);
	// module
	Результат.Вставить("version", ВерсияМодуля);
	// platform
	Результат.Вставить("platform_version", ОписаниеОкруженияМодуля.ВерсияПлатформы);
	// configuration
	Результат.Вставить("marker", ОписаниеОкруженияМодуля.Маркер);
	Результат.Вставить("conf_name", ОписаниеОкруженияМодуля.ИмяКонфигурации);
	Результат.Вставить("conf_version", ОписаниеОкруженияМодуля.ВерсияКонфигурации);
	Результат.Вставить("base_subsystem_name", ОписаниеОкруженияМодуля.ИмяБазовойПодсистемы);
	Результат.Вставить("base_subsystem_version", ОписаниеОкруженияМодуля.ВерсияБазовойПодсистемы);
...
//
&НаКлиенте
Процедура ЗаполнитьОписаниеОбновленияМодуля(ДанныеДляОбновленияМодуля)
	
	ОписаниеОкруженияМодуля = ДанныеДляОбновленияМодуля.ОписаниеОкруженияМодуля;
	ОписаниеОбновленияМодуля = ДанныеДляОбновленияМодуля.ОписаниеОбновленияМодуля;
	
	ТекущаяВерсияМодуля = Объект.ПараметрыКлиентСервер.ВерсияОбработкиБезНомераСборки;
		
	Попытка
		ОписаниеНовойВерсии = ОписаниеНовойВерсииИзСервисаОбновлений(ТекущаяВерсияМодуля, ОписаниеОкруженияМодуля);
	Исключение
	...
	Если ТипЗнч(ОписаниеНовойВерсии) <> Тип("Структура") Тогда
		Возврат;	
	КонецЕсли;
	
	СсылкаНаФайл = СсылкаНаФайлИзОписанияНовойВерсии(ОписаниеНовойВерсии);
	НомерВерсии = НомерВерсииИзОписанияНовойВерсии(ОписаниеНовойВерсии);
	Комментарий = КомментарийИзОписанияНовойВерсии(ОписаниеНовойВерсии);
	
	Если ЗначениеЗаполнено(СсылкаНаФайл) Тогда
		ОписаниеОбновленияМодуля.Версия = НомерВерсии;
		ОписаниеОбновленияМодуля.СсылкаНаФайл = СсылкаНаФайл;
		ОписаниеОбновленияМодуля.ЕстьНоваяВерсия = Истина;
	ИначеЕсли ЗначениеЗаполнено(Комментарий) Тогда
		ОписаниеОбновленияМодуля.Версия = НомерВерсии;
		ДанныеДляОбновленияМодуля.КомментарийСервиса = Комментарий;
	КонецЕсли;
	
КонецПроцедуры

// Извлекает ссылку на файл из описания новой версии сервиса обновлений
//
// Параметры:
//  ОписаниеНовойВерсии - Структура - см. функцию ОписаниеНовойВерсииИзСервисаОбновлений()
// 
// Возвращаемое значение:
//  Строка - ссылка для скачивания файла новой версии модуля
//
&НаКлиенте
Функция СсылкаНаФайлИзОписанияНовойВерсии(ОписаниеНовойВерсии)
	
	Результат = "";
	
	links = Неопределено;
	Если Не ОписаниеНовойВерсии.Свойство("links", links)
		 Или ТипЗнч(links) <> Тип ("Массив") Тогда
		Возврат Результат;
	КонецЕсли;
	
	Для Каждого link Из links Цикл
		Если link.rel = "content" Тогда
			Результат = link.href;
			Прервать;
		КонецЕсли;
	КонецЦикла;
...
// Возвращает версию модуля из описания от сервиса обновлений
//
// Параметры:
//  ОписаниеНовойВерсии - Структура - см. функцию ОписаниеНовойВерсииИзСервисаОбновлений()
// 
...
//
&НаКлиенте
Функция НомерВерсииИзОписанияНовойВерсии(ОписаниеНовойВерсии)
	
	Результат = "";
	
	Если ОписаниеНовойВерсии.Свойство("name") Тогда
		Результат = ОписаниеНовойВерсии.name;
	КонецЕсли;
...
// Извлекает описание новой версии или комментарий о причине её отсутствия
// 	из описания новой версии сервиса обновлений
//
// Параметры:
//  ОписаниеНовойВерсии - Структура - см. функцию ОписаниеНовойВерсииИзСервисаОбновлений()
// 
// Возвращаемое значение:
//  Строка - описание новой версии или комментарий о причине её отсутствия
//
&НаКлиенте
Функция КомментарийИзОписанияНовойВерсии(ОписаниеНовойВерсии)
	
	Результат = "";
	
	Если ОписаниеНовойВерсии.Свойство("description") Тогда
		Результат = ОписаниеНовойВерсии.description;
	КонецЕсли;
...
Функция ПроверитьВозможностьОбновленияФайлаМодуля(ПутьКФайлу)
	...
	УникальнаяЧасть		 = УникальноеИмяФайла("txt");
	ОбщаяЧасть			 = "Diadoc_WriteTest";
	ИмяТестовогоФайла	 = ОбщаяЧасть + "_" + УникальнаяЧасть;
...
//
&НаКлиенте
Функция УникальноеИмяФайла(Расширение = Неопределено)
...
// Проверяет по хэш-сумме, что файл модуля не был изменен
//
// Параметры:
//  ДанныеДляОбновленияМодуля - Структура - см. функцию НовыеДанныеДляОбновленияМодуля()
// 
// Возвращаемое значение:
//  Булево - Истина, если модуль доработан
//
&НаКлиенте
Функция МодульДоработан(ДанныеДляОбновленияМодуля)
	...
	ВерсияМодуля = Объект.ПараметрыКлиентСервер.ВерсияОбработкиБезНомераСборки;
	РасположениеМодуля = ДанныеДляОбновленияМодуля.РасположениеМодуля;
	
	Попытка
		ХешСуммаТекущегоМодуля = ХешСуммаТекущегоМодуля(РасположениеМодуля);
		ХешСуммаТиповогоМодуля = ХешСуммаТиповогоМодуля(ВерсияМодуля);
	Исключение
		
		ОписаниеОшибки = ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
		ЗарегистрироватьОшибкуАвтообновленияМодуляВЖурналеРегистрации(ОписаниеОшибки);
		
		ДанныеДляОбновленияМодуля.ОписаниеОшибки = "ПроверкаХешСуммыМодуля" + " " + ОписаниеОшибки();
		
	КонецПопытки;
	
	Если ЗначениеЗаполнено(ХешСуммаТекущегоМодуля)
		И ЗначениеЗаполнено(ХешСуммаТиповогоМодуля)
		И ХешСуммаТекущегоМодуля = ХешСуммаТиповогоМодуля Тогда
		Результат = Ложь;
	КонецЕсли;
...
// Возвращает MD5 хеш-сумму текущего модуля
//
// Параметры:
//  РасположениеМодуля - Структура - см. функцию НовоеОписаниеРасположенияМодуля()
// 
// Возвращаемое значение:
//  Строка - хеш-сумма
//
&НаКлиенте
Функция ХешСуммаТекущегоМодуля(РасположениеМодуля)
	...
	Если Местоположение = МестоположенияМодуля.ФайлНаДиске Тогда
		...
		Результат = MD5Файл(ПутьКФайлу);
		
	ИначеЕсли Местоположение = МестоположенияМодуля.ЭлементСправочника Тогда
		
		ПутьКФайлу = ПолучитьИмяВременногоФайла();
		ФайлОбработки = МетодСервера(, "ФайлОбработкиИзСправочникаВнешнихОбработок", ВнешняяОбработка);
		ФайлОбработки.Записать(ПутьКФайлу);
		Результат = MD5Файл(ПутьКФайлу);
...
// Получает MD5 хеш-сумму оригинального модуля из сервиса
//
// Параметры:
//  ВерсияМодуля - Строка - версия модуля
// 
// Возвращаемое значение:
//  Строка - хеш-сумма модуля
//
&НаКлиенте
Функция ХешСуммаТиповогоМодуля(ВерсияМодуля)
	
	Результат = "";
	
	ХешСуммыXML = ХешСуммыВсехТиповыхМодулей();
	
	ЧтениеXML = Новый ЧтениеXML;
	ЧтениеXML.УстановитьСтроку(ХешСуммыXML);
	ХешСуммы = ФабрикаXDTO.ПрочитатьXML(ЧтениеXML);
	НужнаяВерсия = СтрЗаменить(ВерсияМодуля, ".", "_");
	
	Для Каждого Элемент Из ХешСуммы.Old.UFS.UF Цикл
		Если Элемент.version = НужнаяВерсия Тогда
			Результат = Элемент.md5;
			Прервать;
		КонецЕсли;
	КонецЦикла;
...
//  ОписаниеОбновления - Структура - см. функцию НовоеОписаниеОбновленияМодуля();
//
&НаКлиенте
Процедура ВыполнитьОбновлениеМодуляВФайлеНаДиске(ПутьКФайлу, ОписаниеОбновления)
...
//
&НаКлиенте
Процедура ВыполнитьОбновлениеМодуляВСправочнике(ВнешняяОбработка, ОписаниеОбновления)
	
	СсылкаНаФайл = ОписаниеОбновления.СсылкаНаФайл;
	
	ФайлНовойВерсии = СкачатьФайлИзИнтернета(СсылкаНаФайл);
	
	МетодСервера(, "ОбновитьМодульВСправочникеДополнительныхОбработок", ВнешняяОбработка, ФайлНовойВерсии);
...
Функция ПодключитьКомпонентуДиадока() Экспорт
	...
	ПутьКФайлу = ПутьКФайлуКомпонентыДиадока();
	
	Если ЗначениеЗаполнено(ПутьКФайлу) Тогда
		ВерсияКомпоненты = ПодключитьКомпонентуДиадокаИзФайла(ПутьКФайлу);
	Иначе
		ВерсияКомпоненты = ПодключитьКомпонентуДиадокаПоУмолчанию();
	КонецЕсли;
...
//
&НаКлиенте
Функция ПодключитьКомпонентуДиадокаБезРегистрации(ПутьКФайлу)
...
//
&НаКлиенте
Функция ПодключитьКомпонентуДиадокаЧерезРегистрацию(ПутьКФайлу, ТребуемаяВерсия)
...
Функция ФайлКомпонентыЕстьНаДиске(ВерсияКомпоненты)
	...
	ПутьКФайлу = ПутьКФайлуКомпонентыДиадокаПоУмолчанию(ВерсияКомпоненты);
...
&НаКлиенте
Функция ПутьКФайлуКомпонентыДиадока()
	
	ПараметрыОкружения = Объект.ПараметрыКлиентСервер.ПараметрыОкружения;
	Результат = ПараметрыОкружения.ПутьКФайлуКомпоненты;
...
&НаКлиенте
Функция ПодключитьКомпонентуДиадокаИзФайла(ПутьКФайлу)
	
	КомпонентаПодключена = ПодключитьКомпонентуДиадокаБезРегистрации(ПутьКФайлу);
	Результат = ВерсияУстановленнойКомпонентыДиадока();
...
&НаКлиенте
Функция ПодключитьКомпонентуДиадокаПоУмолчанию()
	...
	Если Не КомпонентаПодключена Тогда
		...
		Если Не КомпонентаПодключена Тогда
			КомпонентаПодключена = ПодключитьКомпонентуДиадокаЧерезРегистрацию(ПутьКФайлу, ВерсияКомпоненты);
		КонецЕсли;
...
//
&НаКлиенте
Функция ПутьКФайлуКомпонентыДиадокаПоУмолчанию(ВерсияКомпоненты)
...
&НаКлиенте
Функция DD_API_GetBillingAccounts(BoxId, АвторизационныйТокен)
	
	ПараметрыСервиса = ОбщиеПараметрыHTTPСервиса();
	
	ПараметрыСервиса.Вставить("Токен", АвторизационныйТокен);
...
// Возвращает сырой ответ от сервиса биллинга по онлайн счетам
//
// Параметры:
//  AccountId			 - Строка - ИД биллинг аккаунта - 
//  АвторизационныйТокен - Строка - Токен авторизации - 
// 
// Возвращаемое значение:
//   - Строка -  Тело ответа от сервиса в формате JSON
&НаКлиенте
Функция Kontur_API_GetPortalBills(AccountId, АвторизационныйТокен) Экспорт
	
	ПараметрыСервиса = НовыеПараметрыHTTPСервиса();
	ПараметрыСервиса.АдресВебСервиса = АдресАпиКонтур();
	
	ПараметрыЗапроса = НовыеПараметрыHTTPЗапроса();
	ПараметрыЗапроса.АдресМетода = "/relevant-offers/v1/sources/diadoc/accounts/" + AccountId;
	ПараметрыЗапроса.Заголовки.Вставить("x-Auth-ddToken", АвторизационныйТокен); 
	
	АдресЗапроса = ПараметрыСервиса.АдресВебСервиса + ПараметрыЗапроса.АдресМетода;
	
	Ответ = Компонента_HttpTransport(АдресЗапроса, ПараметрыЗапроса.Заголовки);
	
	Результат = "[]";
	
	Если НЕ ПараметрыЗапроса.ДопустимыеКодыОтвета.Найти(Ответ.StatusCode) =  Неопределено Тогда
		Результат = Ответ.HttpContent.DataString;
	Иначе   
		СыройТекстОшибки = НСтр(
		"ru = 'Ошибка HTTP запроса
		|Код ошибки: %1
		|%2'"); 
		
		ТекстОшибки = ПодставитьПараметрыВСтроку(СыройТекстОшибки, Ответ.StatusCode, Ответ.HttpContent.DataString);
...
// Получение двоичных данных счета на оплату сервиса
//
// Параметры:
//  АдресФайла			 - Строка -  Адрес по которому находится файл без учета домена и метода  - 
//  АвторизационныйТокен - Строка -  Токен Авторизации Организации  - 
// 
// Возвращаемое значение:
//   Двоичные данные файла
&НаКлиенте
Функция Kontur_API_GetPortalBillsContent(АдресФайла, АвторизационныйТокен) Экспорт
	Заголовки = Новый Соответствие;
	Заголовки.Вставить("x-Auth-ddToken"	, АвторизационныйТокен);
	
	АдресЗапроса = АдресАпиКонтур() + "/relevant-offers/v1/offers/" + АдресФайла;
...
// Возвращает ИД биллинг аккаунта Kontur 
//
// Параметры:
//  BoxId					 - Строка - BoxId Организации Диадок
//  АвторизационныйТокен 	 - Строка - Токен Авторизации Организации 
// 
// Возвращаемое значение:
//  Строка - AccountId ИД биллинг аккаунта Kontur
//
&НаКлиенте
Функция ИдентификаторЛицевогоСчетаДиадок(BoxId, АвторизационныйТокен) Экспорт 
	AccountId			= Неопределено;
	ОтветАПИ 			= DD_API_GetBillingAccounts(BoxId, АвторизационныйТокен);
	ИДПродуктаДиадок	= 7;
...
// Отвечает на вопрос о том есть ли не оплаченные счета сервиса
//
// Параметры:
//  AccountId			 - Строка - ИД Биллинг аккаунта - 
//  АвторизационныйТокен - Строка - Токен авторизации организации Диадок - 
// 
// Возвращаемое значение:
//   -  Булево - Ответ о присутствии счетов на оплату
&НаКлиенте
Функция ЕстьОнлайнСчетаНаОплату(AccountId, АвторизационныйТокен) Экспорт
	Результат = Ложь;
	ПустойОтвет = "[]";
	
	ОтветСервиса = Kontur_API_GetPortalBills(AccountId, АвторизационныйТокен); 
	
	Если НЕ ОтветСервиса = ПустойОтвет Тогда
		Результат = Истина;
	КонецЕсли;
...
&НаКлиенте
Функция АдресАпиКонтур() 
	Результат  = "https://api.kontur.ru";
	Возврат Результат;
КонецФункции
...
#Область УведомлениеПользователя

&НаКлиенте
Функция УведомленияПользователей_СписокУведомлений(ВерсияОбработки) Экспорт 
	
	ОписаниеКофигурации = ОписаниеКофигурации();
	
	КритерииОтбораУведомлений = МетодСервера(, "УведомленияПользователей_Новый_КритерииОтбора");
	КритерииОтбораУведомлений.ВерсияКонфигурации = ОписаниеКофигурации.Версия;
	КритерииОтбораУведомлений.ИмяКонфигурации    = ОписаниеКофигурации.Имя;
	КритерииОтбораУведомлений.ВерсияМодуля       = ВерсияОбработки;
	КритерииОтбораУведомлений.ВерсияПлатформы    = ОписаниеСистемнойИнформации().ВерсияПриложения;
	
	Попытка
		
		ФайлУведомлений = УведомленияПользователей_ПолучитьФайлУведомлений();
		Результат = МетодСервера(, "УведомленияПользователей_СписокУведомлений", ФайлУведомлений, КритерииОтбораУведомлений);
	...
	Исключение
		...
		Ошибка_Обработать(ВидОперации, ТектОшибки);
...
&НаКлиенте
Функция УведомленияПользователей_ПолучитьФайлУведомлений()
	
	ПараметрыСервиса = ОбщиеПараметрыHTTPСервиса();
	
	ПараметрыЗапроса = НовыеПараметрыHTTPЗапроса();
	ПараметрыЗапроса.АдресМетода	= "/1c-addin/update/notification-uf.xml";
	ПараметрыЗапроса.ТелоОтветаКакДвоичныеДанные = Истина;
...
//{ СЛУЖЕБНЫЕ ПРОЦЕДУРЫ И ФУНКЦИИ
	...
	//	
	&НаКлиенте
	Функция ЭтоАгентскаяФункцияУПДУКД(ФункцияДокумента) Экспорт
	
		АгентскиеФункцииУПДУКД = АгентскиеФункцииУПДУКД();
		
		Результат = АгентскиеФункцииУПДУКД.Найти(ФункцияДокумента) <> Неопределено;
	...
	Функция ВариантыИспользованияПроксиСервера() Экспорт
		...
		ДоступныеРежимыПрокси = ДоступныеРежимыПроксиВМодуле();
		
		Результат.Добавить(ДоступныеРежимыПрокси.НеИспользовать		  		, "Не использовать");
		Результат.Добавить(ДоступныеРежимыПрокси.ИспользоватьПроксиСервер	, "Использовать прокси-сервер");
		Результат.Добавить(ДоступныеРежимыПрокси.ИспользоватьНастройкиIE	, "Использовать настройки Internet Explorer");
	...
	&НаКлиенте
	Функция ПараметрыОповещенияВСтрокуHTMLСообщения(ОбработчикОповещения, РезультатОповещения = Неопределено, ЗакрыватьФормуСообщения = Ложь) Экспорт
		
		Если ЗакрыватьФормуСообщения Тогда
			Результат = "ЗакрытиеИОповещение:" + ОбработчикОповещения;
		Иначе
	...
	Функция ПараметрыОповещенияИзСтрокиHTMLСообщения(СтрокаОповещения) Экспорт
		...
		ЗакрыватьФормуСообщения = Найти(НРег(СтрокаОповещения), НРег("ЗакрытиеИОповещение:")) > 0;
		
		Результат = Новый Структура;
		Результат.Вставить("ОбработчикОповещения"	, ОбработчикОповещения);
		Результат.Вставить("РезультатОповещения"	, РезультатОповещения);
		Результат.Вставить("ЗакрыватьФормуСообщения", ЗакрыватьФормуСообщения);
	...
	&НаКлиенте
	Функция ЗначениеВСтрокуJSON(Значение, ПараметрыЗаписиJSON = Неопределено)
	...
	&НаКлиенте
	Функция Перечисление_ТипыОтветногоДействия() Экспорт
	...
	// Псевдоперечисление. Возможные точки вызова универсальных форм.
	&НаКлиенте
	Функция ТочкиВызоваУниверсальныхФорм() Экспорт
		
		Результат = Новый Структура;
		
		Результат.Вставить("ТаблицаДокументовНаОтправку", "ТаблицаДокументовНаОтправку");
		Результат.Вставить("ТаблицаДокументовИсходящих"	, "ТаблицаДокументовИсходящих");
		Результат.Вставить("ТаблицаДокументовВходящих"	, "ТаблицаДокументовВходящих");
		Результат.Вставить("ТаблицаДокументовВнутренних", "ТаблицаДокументовВнутренних");
		Результат.Вставить("ПереотправкаДокумента"		, "ПереотправкаДокумента");
	...
	// Псевдоперечисление. Возможные значения поля ProxyMode объекта компоненты
	//
	// Возвращаемое значение:
	//	Фиксированная структура
	&НаКлиенте
	Функция ДоступныеРежимыПроксиВКомпоненте() Экспорт 
		
		// https://1c-docs.diadoc.ru/ru/latest/ComObjects/Enums/ProxyMode.html
		
		Результат = Новый Структура;
		
		Результат.Вставить("NoProxy"		, "NoProxy"); 			// не использовать прокси-сервер при подключении
		Результат.Вставить("UseProxy"		, "UseProxy"); 			// использовать настройки прокси-сервера, указанные в ProxySettings
		Результат.Вставить("UseDefaultProxy", "UseDefaultProxy");	// использовать прокси-сервер по умолчанию
	...
	// Псевдоперечисление. Возможные значения настройки режим использования прокси сервера
	//
	// Возвращаемое значение:
	//	Фиксированная структура
	&НаКлиенте
	Функция ДоступныеРежимыПроксиВМодуле()
		
		Результат = Новый Структура;
		
		Результат.Вставить("НеИспользовать"				, "НеИспользовать");
		Результат.Вставить("ИспользоватьПроксиСервер"	, "ИспользоватьПроксиСервер");
		Результат.Вставить("ИспользоватьНастройкиIE"	, "ИспользоватьНастройкиIE");
	...
	// Мапит строковое значение настроки режим использования прокси сервера из компоненты
	// настройку режим использования прокси сервера в модуле
	//
	// Параметры:
	//	ProxyMode - Строка - режим прокси полученный из объекта компоненты. См. "ДоступныеРежимыПроксиВКомпоненте()"
	//
	// Возвращаемое значение:
	//	Структура с ключами: 
	//		"Значение" - значение настройки прокси в модуле
	//		"Представление" - представление настройки прокси в модуле
	&НаКлиенте
	Функция РежиПроксиКомпонентыВРежимПроксиМодуля(ProxyMode) Экспорт
		
		Результат = Новый Структура;
						
		ВариантыProxyMode 	= ДоступныеРежимыПроксиВКомпоненте();
		ДоступныеРежимы		= ДоступныеРежимыПроксиВМодуле();
		
		Если ProxyMode = ВариантыProxyMode.NoProxy Тогда
			Значение = ДоступныеРежимы.НеИспользовать;
		ИначеЕсли ProxyMode = ВариантыProxyMode.UseProxy Тогда
			Значение = ДоступныеРежимы.ИспользоватьПроксиСервер;
		ИначеЕсли ProxyMode = ВариантыProxyMode.UseDefaultProxy Тогда
			Значение = ДоступныеРежимы.ИспользоватьНастройкиIE;
		Иначе
			Значение = "";
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(Значение) Тогда
			ВариантыИспользованияПрокси = ВариантыИспользованияПроксиСервера();
			Представление = ВариантыИспользованияПрокси.НайтиПоЗначению(Значение).Представление;
		КонецЕсли;
	...
	// Псевдоперечисление. Возможные значения поля ResolutionRequestType в компоненте
	//
	// Возвращаемое значение:
	//	Соответствие
	&НаКлиенте
	Функция ДоступныеТипыЗапросовВКомпоненте() Экспорт
	
		Результат = Новый Структура;
		
		Результат.Вставить("ЗапросКонечнойПодписи"					, "SignatureRequest");
		Результат.Вставить("ЗапросСогласующейПодписи"				, "ApprovementSignatureRequest");
		Результат.Вставить("ЗапросСогласования"						, "ApprovementRequest");
		Результат.Вставить("ЗапросКонечнойПодписиАннулирования"		, "RevocationSignatureRequest");
		Результат.Вставить("ЗапросСогласующейПодписиАннулирования"	, "RevocationApprovementSignatureRequest");
		Результат.Вставить("ЗапросСогласованияАннулирования"		, "RevocationAgreementRequest");
		Результат.Вставить("НеСтандартныйТипЗапроса"				, "Custom");
...
//{ ИНТЕГРАЦИЯ
	...
	Функция ПолучитьРезультатВыполненияЗадач(МассивЗадач, ПараметрыВыборки)
		...
		ФильтрыДокументовПоТипу = ФильтрыДокументовПоТипу();
				...
				Если Задача.Task.IsCompleted Тогда
					...
					Для ИндексДокумента = 0 По ВГраница Цикл
						...
						Если Document.Counteragent <> Неопределено Тогда
							...
							ЭтоИУПД = ИмяТипа = "UniversalTransferDocumentRevision";
							ЭтоУПД = (ИмяТипа = "UniversalTransferDocument" Или ЭтоИУПД);
							Если Не ПустаяСтрока(ФильтрПотипамДокументов) И ЭтоУПД Тогда
								
								Если ЭтоИУПД Тогда
									ТипДокумента = ТипДокументаИУПД(Document.Function);
								иначе
									ТипДокумента = ТипДокументаУПД(Document.Function);
								КонецЕсли; 
								
								
								Если ТипДокумента = ФильтрыДокументовПоТипу.УПД_СЧФДОП.Представление
									//ТипДокументаУПД("СЧФДОП")
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.УПД_СЧФДОП.ЗначениеФильтра
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.ИУПД_СЧФДОП.ЗначениеФильтра
									
								ИЛИ ТипДокумента = ФильтрыДокументовПоТипу.УПД_СЧФ.Представление
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.СФ.ЗначениеФильтра
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.УПД_СЧФ.ЗначениеФильтра
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.ИУПД_СЧФ.ЗначениеФильтра
									
								ИЛИ ТипДокумента = ФильтрыДокументовПоТипу.УПД_СвРК.Представление
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.УПД_СвРК.ЗначениеФильтра
									
								ИЛИ ТипДокумента = ФильтрыДокументовПоТипу.УПД_СвЗК.Представление
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.УПД_СвЗК.ЗначениеФильтра
									
								ИЛИ ТипДокумента = ФильтрыДокументовПоТипу.ИУПД_СвРК.Представление
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.ИУПД_СвРК.ЗначениеФильтра
									
								ИЛИ ТипДокумента = ФильтрыДокументовПоТипу.ИУПД_СвЗК.Представление
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.ИУПД_СвЗК.ЗначениеФильтра
									
								ИЛИ ТипДокумента = ФильтрыДокументовПоТипу.УПД_ДОП.Представление
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.Накладные.ЗначениеФильтра
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.УПД_ДОП.ЗначениеФильтра
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.ИУПД_ДОП.ЗначениеФильтра
								Тогда
									Продолжить;
								КонецЕсли;
							...
							Если Не ПустаяСтрока(ФильтрПотипамДокументов) И ЭтоУКД Тогда
								...
								Если 	ТипДокумента = ФильтрыДокументовПоТипу.УКД_КСЧФДИС.Представление
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.УКД_КСЧФДИС.ЗначениеФильтра
									
								ИЛИ ТипДокумента = ФильтрыДокументовПоТипу.УКД_КСЧФ.Представление
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.СФ.ЗначениеФильтра
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.УКД_КСЧФ.ЗначениеФильтра
																		
								ИЛИ ТипДокумента = ФильтрыДокументовПоТипу.УКД_СвИСРК.Представление
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.УКД_СвИСРК.ЗначениеФильтра
									
								ИЛИ ТипДокумента = ФильтрыДокументовПоТипу.УКД_СвИСЗК.Представление
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.УКД_СвИСЗК.ЗначениеФильтра
									
								ИЛИ ТипДокумента = ФильтрыДокументовПоТипу.УКД_ДИС.Представление
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.Накладные.ЗначениеФильтра
									И ФильтрПотипамДокументов <> ФильтрыДокументовПоТипу.УКД_ДИС.ЗначениеФильтра
								Тогда
									Продолжить;
								КонецЕсли;
	...
	Процедура ЗаполнитьСтрокуТаблицыДокумента(Document, СтруктураДокумента, НаименованиеЯщика = Неопределено, ЗаполнятьПервичныйДокумент = Истина)
		...
		Если Document.RoamingNotificationStatus <> "RoamingNotificationStatusNone" 
			И Document.RoamingNotificationStatus <> "RoamingNotificationStatusError" Тогда
			
			СостояниеДокументооборота = СтруктураДокумента.СостояниеПередачиЧерезРоуминг;
			Если ЗначениеЗаполнено(СтруктураДокумента.СостояниеДокументооборота) Тогда
				СостояниеДокументооборота = СостояниеДокументооборота + " " + СтруктураДокумента.СостояниеДокументооборота;
			КонецЕсли;
			СтруктураДокумента.СостояниеДокументооборота		= СостояниеДокументооборота;
		...
		Иначе
			...
			СтруктураДокумента.Вставить("ДатаУчета"	, Document.Timestamp);	// Timestamp возвращается в в текущем часовом поясе
		КонецЕсли;
		...
		ЗаполнитьСтатусМЧДВСтрокеДокумента(СтруктураДокумента, Document);
		
	КонецПроцедуры
	
	&НаКлиенте
	Процедура ЗаполнитьСтатусМЧДВСтрокеДокумента(СтруктураДокумента, Document)
		
		СтруктураДокумента.Вставить("СтатусМЧД");
		СтруктураДокумента.Вставить("СтатусМЧДКритичность");
		
		СтатусМЧД = Document.DocflowStatus.PowerOfAttorneyStatus;
		
		Если СтатусМЧД <> Неопределено Тогда
			
			СтруктураДокумента.СтатусМЧД			= СтатусМЧД.Text;
			СтруктураДокумента.СтатусМЧДКритичность	= СтатусМЧД.Severity;
	...
	&НаКлиенте
	Функция УровниКритичностиСтатусаДокумента()
	...
	Функция НоваяСтрокаКонтекста(Организация, BoxId)
		...
		Результат.Вставить("ТребуетсяМЧД"		, ?(Не Результат.ЗаблокированаПоAPI, Результат.Box.MyEmployee.NeedToAttachPowerOfAttorney, Ложь));
	...
	Функция НоваяСтрокаКонтекста_ДанныеОрганизации(Box)
		...
		SignerType = Перечисление_SignerType();
		...
		Если Результат.AuthenticateType = "Certificate" Тогда
			...
			Если Результат.Certificate.OwnerType = SignerType.PhysicalPerson 
				И Результат.Inn = Результат.Certificate.Inn Тогда
				
				Результат.Certificate.OwnerType = SignerType.IndividualEntity;
	...
	Процедура ИнициализироватьMagic() Экспорт
		...
		Для каждого СтрокаКонтекста Из Платформа.ПараметрыКлиент.КонтекстДиадока Цикл
			...
			Если  СтрокаКонтекста.ДанныеОрганизации.AuthenticateType = "Certificate"
				...
				КонтекстМЧД	= МетодКлиента("Модуль_Клиент", "МЧД_ДанныеПоИспользованиюДоверенностей", СтрокаКонтекста.BoxId, Истина);
				ЭтоДействующаяМЧД = МетодКлиента("Модуль_Клиент", "СвойствоСтруктуры", КонтекстМЧД.РезультатПроверкиМЧД, "ЭтоДействующаяМЧД", Ложь);
				
				Попытка
					СтрокаКонтекста.Magic = СтрокаКонтекста.Box.GetReceiptGenerationProcess();
					Если ЗначениеЗаполнено(КонтекстМЧД.МЧД) И ЭтоДействующаяМЧД Тогда
						СтрокаКонтекста.Magic.PowerOfAttorneyToAttach.UseDefault = Истина;
					КонецЕсли;	
	...
	Процедура ЗаполнитьПодписанта(Content, Organization, ПараметрыОтправкиНаСогласование = Неопределено) Экспорт
		...
		Если 	ТипКонтента = "UniversalTransferDocument" ИЛИ Лев(ТипКонтента, 3) = "Utd"
			...
			Если ПараметрыОтправкиНаСогласование <> Неопределено Тогда 
				...
				ExtendedSigner.SignerDetails.SignerType	= ТипПодписантаДляКонтента(Organization.Certificate);
	...
	&НаКлиенте
	Функция ТипПодписантаДляКонтента(ДанныеСертификата) Экспорт
		
		SignerType = Перечисление_SignerType();
		
		ПодписантИП = ПодписантИП(ДанныеСертификата);
	...
	&НаКлиенте
	Функция ПодписантИП(ДанныеСертификата) Экспорт
		
		SignerType = Перечисление_SignerType();
		
		Результат = ЗначениеЗаполнено(ДанныеСертификата) 
					И ДанныеСертификата.OwnerType = SignerType.IndividualEntity;
	...
	&НаКлиенте
	Функция Перечисление_SignerType() Экспорт
		
		Результат = Новый Структура;
		
		Результат.Вставить("LegalEntity",		"LegalEntity");
		Результат.Вставить("IndividualEntity",	"IndividualEntity");
		Результат.Вставить("PhysicalPerson",	"PhysicalPerson");
	...
	Функция ТипДокументаУКД(ФункцияУКД) Экспорт
		...
		ИначеЕсли ФункцияУКД = "СвИСРК" Тогда
			Результат = "УКД СвИСРК";
		ИначеЕсли ФункцияУКД = "СвИСЗК" Тогда
			Результат = "УКД СвИСЗК";
		КонецЕсли;
	...
	Функция ТипДокументаИУПД(ФункцияИУПД) Экспорт
		...
		Если ФункцияИУПД = "СЧФДОП" ИЛИ ФункцияИУПД = "InvoiceAndBasic" Тогда
			Результат = "Исправление УПД Счф Доп";
		ИначеЕсли ФункцияИУПД = "ДОП" ИЛИ ФункцияИУПД = "Basic" Тогда
			Результат = "Исправление УПД Доп";
		ИначеЕсли ФункцияИУПД = "СЧФ" ИЛИ ФункцияИУПД = "Invoice" Тогда
			Результат = "Исправление УПД Счф";
		ИначеЕсли ФункцияИУПД = "СвРК" Тогда
			Результат = "Исправление УПД СвРК";
		ИначеЕсли ФункцияИУПД = "СвЗК" Тогда
			Результат = "Исправление УПД СвЗК";	
		КонецЕсли;
	...
	//			* ЗначениеФильтра	- Строка - Строковый идентификатор фильтра
	&НаКлиенте	
	Функция ФильтрыДокументовПоТипу() Экспорт
		...
		ДобавитьВозможныйФильтрПоТипу(Результат, "УПД_СвРК",	ТипДокументаУПД("СвРК"),	"УПД_СвРК");
		ДобавитьВозможныйФильтрПоТипу(Результат, "УПД_СвЗК",	ТипДокументаУПД("СвЗК"),	"УПД_СвЗК");
		
		ДобавитьВозможныйФильтрПоТипу(Результат, "УКД_КСЧФДИС",	ТипДокументаУКД("КСЧФДИС"),	"6");
		ДобавитьВозможныйФильтрПоТипу(Результат, "УКД_СвИСРК",	ТипДокументаУКД("СвИСРК"),	"УКД_СвИСРК");
		ДобавитьВозможныйФильтрПоТипу(Результат, "УКД_СвИСЗК",	ТипДокументаУКД("СвИСЗК"),	"УКД_СвИСЗК");
		
		ДобавитьВозможныйФильтрПоТипу(Результат, "ИУПД_СЧФДОП",	ТипДокументаИУПД("СЧФДОП"),	"7");
		ДобавитьВозможныйФильтрПоТипу(Результат, "ИУПД_СвРК",	ТипДокументаИУПД("СвРК"),	"ИУПД_СвРК");
		ДобавитьВозможныйФильтрПоТипу(Результат, "ИУПД_СвЗК",	ТипДокументаИУПД("СвЗК"),	"ИУПД_СвЗК");
		
		ДобавитьВозможныйФильтрПоТипу(Результат, "Торг2",						"Акт о расхождениях ТОРГ-2", "Torg2");
		...
		ДобавитьВозможныйФильтрПоТипу(Результат, "Прочее",						"Прочее", "47");
		ДобавитьВозможныйФильтрПоТипу(Результат, "ДополнительноеСоглашение",	"Дополнительное соглашение", "48");
		
		Возврат Результат;
		
	КонецФункции
	
	// Добавляет описание возможного фильтра типа документов в структуру
	&НаКлиенте
	Процедура ДобавитьВозможныйФильтрПоТипу(ФильтрыДокументовПоТипу, Ключ, Представление, ЗначениеФильтра)
		
		СтруктураТипа = Новый Структура("Представление, ЗначениеФильтра", Представление, ЗначениеФильтра); 
		
		ФильтрыДокументовПоТипу.Вставить(Ключ, СтруктураТипа);
...
//{ ИНТЕРАКТИВНЫЕ ДЕЙСТВИЯ
	...
	//
	&НаКлиенте
	Функция ПодписатьВДиадоке(Document, ПротоКонтент = Неопределено, Асинхронно = Ложь, КонтрактМЧД = Неопределено) Экспорт
	...
	//
	&НаКлиенте
	Процедура ОтказатьВПодписи(Document, ТекстОтказа = "", КонтрактМЧД = Неопределено) Экспорт
	...
	//
	&НаКлиенте
	Процедура ЗапроситьУточнение(Document, Комментарий = "", КонтрактМЧД = Неопределено) Экспорт
		...
		Если 	ContentItem.Content.Type = "XmlSignatureRejection"
			Или ContentItem.Content.Type = "InvoiceCorrectionRequest" Тогда
	...
	// Параметры:
	//	Document 					- COMОбъект - Объект, производный от Document
	//	ПараметрыОтветныхДействий 	- Структура	- см. ПараметрыОтветныхДействий()
	//
	&НаКлиенте
	Процедура ВыполнитьОтветноеДействиеПоДокументу(Document, ПараметрыОтветныхДействий) Экспорт
		...
		ReplySendTask = МетодКлиента(	"Модуль_РаботаССерверомДиадок", 
										"ReplySendTask", 
										Document, 
										ПараметрыОтветныхДействий.ТипОтветногоДействия,
										ПараметрыОтветныхДействий.КонтрактМЧД);
										
		ContentItem = ReplySendTask.ContentItems.GetItem(0);
		
		Если ContentItem.Content.Type = "XmlSignatureRejection"
			Или ContentItem.Content.Type = ПараметрыОтветныхДействий.ТипОтветногоДействия Тогда
			ЗаполнитьПодписанта(ContentItem.Content, Document.Organization);
		КонецЕсли;
		
		Комментарий = ПараметрыОтветныхДействий.Комментарий;
		Если ЗначениеЗаполнено(Комментарий) Тогда
			ContentItem.Content.Comment = Комментарий;
		КонецЕсли;
	...
	&НаКлиенте
	Функция ПараметрыОтветныхДействий() Экспорт
		
		Результат = Новый Структура;
		Результат.Вставить("ТипОтветногоДействия");
		Результат.Вставить("Комментарий");
		Результат.Вставить("КонтрактМЧД");
	...
	//
	&НаКлиенте
	Процедура АннулироватьДокумент(Document, КонтрактМЧД = Неопределено) Экспорт
...
//{ ПОЛУЧИТЬ...
	...
	Функция ПолучитьМассивТиповДокументов(ФильтрПоТипамДокументов, ВидТипаДокумента)
		...
		Если ФильтрПотипамДокументов = ""
			ИЛИ ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.Накладные.ЗначениеФильтра Тогда // Накладные
		...
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.Торг12.ЗначениеФильтра Тогда // только Торг-12
		...
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.Акт.ЗначениеФильтра Тогда // только Акт
		...
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.УПД_ДОП.ЗначениеФильтра Тогда // УПД (ПД)
			
			Если ВидТипаДокумента = 0 или ВидТипаДокумента = 2 Тогда
				МассивТиповДокументов.Добавить("UniversalTransferDocument");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.УКД_ДИС.ЗначениеФильтра Тогда // УКД (ДИС)
			
			Если ВидТипаДокумента = 0 или ВидТипаДокумента = 2 Тогда
				МассивТиповДокументов.Добавить("UniversalCorrectionDocument");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.ИУПД_ДОП.ЗначениеФильтра Тогда // иУПД (ДОП)
		...
		Если ФильтрПотипамДокументов = ""
			ИЛИ ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.СФ.ЗначениеФильтра Тогда // Счет-фактуры
		...
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.ОСФ.ЗначениеФильтра Тогда // только Счет-фактура
			
			Если ВидТипаДокумента = 0 ИЛИ ВидТипаДокумента = 1 Тогда
				МассивТиповДокументов.Добавить("Invoice");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.ИСФ.ЗначениеФильтра Тогда // только ИСФ
			
			Если ВидТипаДокумента = 0 ИЛИ ВидТипаДокумента = 1 Тогда
				МассивТиповДокументов.Добавить("InvoiceRevision");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.КСФ.ЗначениеФильтра Тогда // только КСФ и ИКСФ
		...
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.УПД_СЧФ.ЗначениеФильтра
				ИЛИ ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.УПД_СвРК.ЗначениеФильтра
				ИЛИ ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.УПД_СвЗК.ЗначениеФильтра Тогда // УПД (СФ) или УПД СвРК или УПД СвЗК
			
			Если ВидТипаДокумента = 0 или ВидТипаДокумента = 1 Тогда
				МассивТиповДокументов.Добавить("UniversalTransferDocument");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.УКД_КСЧФ.ЗначениеФильтра
				ИЛИ ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.УКД_СвИСРК.ЗначениеФильтра
				ИЛИ ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.УКД_СвИСЗК.ЗначениеФильтра Тогда // УКД (КСЧФ) или УКД СвИСРК или УКД УКДСвИСЗК
				
			Если ВидТипаДокумента = 0 или ВидТипаДокумента = 1 Тогда
				МассивТиповДокументов.Добавить("UniversalCorrectionDocument");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.ИУПД_СЧФ.ЗначениеФильтра
				ИЛИ ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.ИУПД_СвРК.ЗначениеФильтра
				ИЛИ ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.ИУПД_СвЗК.ЗначениеФильтра Тогда // иУПД (КСЧФ) или ИУПД СвРК или ИУПД СвЗК
		...
		Если ФильтрПоТипамДокументов = ФильтрыДокументовПоТипу.Торг2.ЗначениеФильтра Тогда
			МассивТиповДокументов.Добавить("Torg2");
		КонецЕсли;
		
		Если ФильтрПотипамДокументов = "" 
			ИЛИ ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.СчетаНаОплату.ЗначениеФильтра Тогда // Счет на оплату
		...
		Если ФильтрПотипамДокументов = "" 
			ИЛИ ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.Неформализованные.ЗначениеФильтра Тогда 	// Неформализованные документы
		...
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.АктСверки.ЗначениеФильтра Тогда 
			
			Если ВидТипаДокумента = 0 ИЛИ ВидТипаДокумента = 2 Тогда
				МассивТиповДокументов.Добавить("ReconciliationAct");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.Детализация.ЗначениеФильтра Тогда 
			
			Если ВидТипаДокумента = 0 ИЛИ ВидТипаДокумента = 3 Тогда
				МассивТиповДокументов.Добавить("ServiceDetails");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.Договор.ЗначениеФильтра Тогда 
			
			Если ВидТипаДокумента = 0 ИЛИ ВидТипаДокумента = 2 Тогда
				МассивТиповДокументов.Добавить("Contract"); 
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.ПротоколСогласованияЦены.ЗначениеФильтра Тогда 
			
			Если ВидТипаДокумента = 0 ИЛИ ВидТипаДокумента = 4 Тогда
				МассивТиповДокументов.Добавить("PriceListAgreement");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.ПриглашениеКЭДО.ЗначениеФильтра Тогда 
			
			Если ВидТипаДокумента = 0 ИЛИ ВидТипаДокумента = 2 Тогда
				МассивТиповДокументов.Добавить("TrustConnectionRequest");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.РеестрСертификатов.ЗначениеФильтра Тогда 
			...
			// 	КонецЕсли;	
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.Прочее.ЗначениеФильтра Тогда 
			
			Если ВидТипаДокумента = 0 ИЛИ ВидТипаДокумента = 4 Тогда
				МассивТиповДокументов.Добавить("Nonformalized");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.ДополнительноеСоглашение.ЗначениеФильтра Тогда
			
			Если ВидТипаДокумента = 0 ИЛИ ВидТипаДокумента = 4 Тогда
				МассивТиповДокументов.Добавить("SupplementaryAgreement");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.УПД_СЧФДОП.ЗначениеФильтра Тогда
			
			Если ВидТипаДокумента = 0 ИЛИ ВидТипаДокумента = 1 Тогда
				МассивТиповДокументов.Добавить("UniversalTransferDocument");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.УКД_КСЧФДИС.ЗначениеФильтра Тогда
			
			Если ВидТипаДокумента = 0 ИЛИ ВидТипаДокумента = 1 Тогда
				МассивТиповДокументов.Добавить("UniversalCorrectionDocument");
			КонецЕсли;
			
		ИначеЕсли ФильтрПотипамДокументов = ФильтрыДокументовПоТипу.ИУПД_СЧФДОП.ЗначениеФильтра Тогда
...
//{ ТЕХНИЧЕСКАЯ ПОДДЕРЖКА
	...
	Функция ТехническаяИнформация() Экспорт
		...
		РежимСовместимости155и820 = Объект.ПараметрыКлиентСервер.ПодключаемыйМодуль.РежимСовместимостиФорматов155и820;
		...
		ТехИнфо.Вставить("РежимСовместимостиФорматов155и820", РежимСовместимости155и820);
		...
		ТехИнфо.Вставить("ОтключеноАвтоматическоеОбновлениеМодуля", ОтключеноАвтоматическоеОбновлениеМодуля());
	...
	Функция ПредставлениеТехническойИнформации() Экспорт
		...
		|Отключено автоматическое обновление модуля: " + ТехИнфо.ОтключеноАвтоматическоеОбновлениеМодуля + "
		|
	...
	Процедура ДополнитьТехИнформациюПараметрамиАутентификации(ТехИнфо)
		...
		Если Не УстановленоСоединениеСДиадокомЧерезКомпоненту() Тогда
			Возврат;
		КонецЕсли;
	...
	&НаКлиенте
	// Проверяет наличие COM-объекта DiadocConnection в КонтекстРаботаССерверомДиадок
	//
	Функция УстановленоСоединениеСДиадокомЧерезКомпоненту()
...
#Область Служебные_методы
	...
	Функция Метрика_Категории() Экспорт
		...
		Результат.Вставить("ЭкстренноеУведомление"		, "Экстренное уведомление");
		Результат.Вставить("ОбновлениеМодуля"			, "Обновление модуля");
	...
	// Приводит строку со значением идентификатора ящика к виду, используемомму в сервисе метрик
	//
	// Параметры:
	//	ИдентификаторЯщика - Строка - идентификатор ящика в Диадок
	//
	// Возвращаемое значение:
	//	Строка
	&НаКлиенте
	Функция Метрики_ПредставлениеBoxId(ИдентификаторЯщика) Экспорт
		
		Если Не ЗначениеЗаполнено(ИдентификаторЯщика) Тогда
			Результат = "нет данных";
		ИначеЕсли Найти(НРег(ИдентификаторЯщика), "@diadoc") > 0 Тогда
			Результат = МетодКлиента("Модуль_Клиент", "ПолучитьBoxGuidПоId", ИдентификаторЯщика);
		Иначе
			Результат = ИдентификаторЯщика;
		КонецЕсли;
...
#Область Регистрация_поведения
	...
	&НаКлиенте
	Процедура Метрика_ДобавитьПоведение_НажатиеКнопки(НазваниеФормы, НазваниеКатегории, НазваниеДействия, Переменные = Неопределено) Экспорт
...
#Область Регистрация_статистики
	...
	Процедура Метрика_ДобавитьСтатистику_Авторизации(ДопПеременные = Неопределено) Экспорт
		...
		МассивBoxId = Метрика_НастроенныеBoxId();
		...
		Если Платформа.ПараметрыКлиент.КонтекстДиадока.Количество() > 0 Тогда
			ТребуетсяМЧД = Платформа.ПараметрыКлиент.КонтекстДиадока[0].ТребуетсяМЧД;
			Переменные.Вставить("НужнаМЧД"	, Формат(ТребуетсяМЧД, "БЛ=false; БИ=true"));
		КонецЕсли;
	...
	//Регистрирует метрику при автоматическом сменен формата отправки документов
	// Параметры:
	//  ОрганизацииИБ  - Массив - организации по которым сменился формат, см. функцию сервера ОрганизацииИКонтрагентыСУтаревшимиНастройкамиОтправки();	
	//
	&НаКлиенте
	Процедура Метрика_ДобавитьСтатистику_УведомлениеОСменеФормата(ОрганизацииИБ) Экспорт
		
		Если Не ИспользоватьМетрики() Тогда
			Возврат;
		КонецЕсли;
		
		Категория	= Метрика_Категории().УведомлениеОСменеФормата;
		Действие	= "Изменить формат";
		
		Для каждого ЭлементКонтекста Из Платформа.ПараметрыКлиент.КонтекстДиадока Цикл
			
			ФорматОтправкиИзменился = ОрганизацииИБ.Найти(ЭлементКонтекста.Организация) <> Неопределено;
			
			Если ФорматОтправкиИзменился Тогда
				
				Переменные = Новый Соответствие;
				Переменные.Вставить("BoxId"		, ЭлементКонтекста.Box.Guid);
	...
	&НаКлиенте
	Процедура Метрика_ДобавитьСтатистику_ВыполнитьОтправку(НазваниеДействия, ДопПеременные) Экспорт
		
		Если Не ИспользоватьМетрики() Тогда
			Возврат;
		КонецЕсли;
						
		Категория	= Метрика_Категории().ОтправкаДокументов;
		Действие	= НазваниеДействия;
	...
	&НаКлиенте
	Процедура Метрика_ЗарегистрироватьУспешноеАвтообновлениеМодуля(ДанныеДляОбновленияМодуля)
		
		РезультатОбновления = "Success";
		
		Топик = ТопикиМетрики().Statistics;
		Действие = "Автоматическое обновление";
		Категория = Метрика_Категории().ОбновлениеМодуля;
		Переменные = Метрика_ОбщиеПеременныеАвтообновленияМодуля(РезультатОбновления, ДанныеДляОбновленияМодуля);
	...
	&НаКлиенте
	Процедура Метрика_ЗарегистрироватьОшибкуАвтообновленияМодуля(ДанныеДляОбновленияМодуля) Экспорт
		
		РезультатОбновления = "Error";
		
		Топик = ТопикиМетрики().Log;
		Действие = "Автоматическое обновление";
		Категория = Метрика_Категории().ОбновлениеМодуля;
		Переменные = Метрика_ОбщиеПеременныеАвтообновленияМодуля(РезультатОбновления, ДанныеДляОбновленияМодуля);
		Метрика_ДополнитьПеременныеАвтообновленияМодуляОписаниямиОшибок(Переменные, ДанныеДляОбновленияМодуля);
	...
	&НаКлиенте
	Функция Метрика_ОбщиеПеременныеАвтообновленияМодуля(РезультатОбновления, ДанныеДляОбновленияМодуля)
		...
		ОписаниеОшибки = ДанныеДляОбновленияМодуля.ОписаниеОшибки; 
		КомментарийМодуля = ДанныеДляОбновленияМодуля.КомментарийМодуля;
		КомментарийСервиса = ДанныеДляОбновленияМодуля.КомментарийСервиса;
				
		BaseId = Объект.ПараметрыКлиентСервер.ИдентификаторБазы;
		МассивBoxId = Метрика_МассивНастроенныхBoxIdВФорматеGUID();
		Тестовый = ДоменПользователяКонтур();
		ТекущаяВерсия = Объект.ПараметрыКлиентСервер.ВерсияОбработки;
		НоваяВерсия	= ДанныеДляОбновленияМодуля.ОписаниеОбновленияМодуля.Версия;
		
		Результат.Вставить("Результат"				, РезультатОбновления);
		Результат.Вставить("BaseId"					, BaseId);
		Результат.Вставить("BoxId"					, МассивBoxId);
		Результат.Вставить("Тестовый"				, Тестовый);
		Результат.Вставить("НоваяВерсия" 			, НоваяВерсия);
		Результат.Вставить("ТекущаяВерсия" 			, ТекущаяВерсия);
		
		Для Каждого Элемент Из РасположениеМодуля Цикл
			Результат.Вставить(Элемент.Ключ, Элемент.Значение);	
		КонецЦикла;
		
		Для Каждого Элемент Из ОписаниеОкруженияМодуля Цикл
			Результат.Вставить(Элемент.Ключ, Строка(Элемент.Значение));	
		КонецЦикла;
	...
	&НаКлиенте
	Процедура Метрика_ДополнитьПеременныеАвтообновленияМодуляОписаниямиОшибок(Переменные, ДанныеДляОбновленияМодуля)
		
		Переменные.Вставить("ОписаниеОшибки" 		, ДанныеДляОбновленияМодуля.ОписаниеОшибки);
		Переменные.Вставить("КомментарийМодуля" 	, ДанныеДляОбновленияМодуля.КомментарийМодуля);
		Переменные.Вставить("КомментарийСервиса" 	, ДанныеДляОбновленияМодуля.КомментарийСервиса);		
		
	КонецПроцедуры
	
	&НаКлиенте
	Функция Метрика_МассивНастроенныхBoxIdВФорматеGUID()
		
		Результат = Новый Массив;
		
		МассивBoxIdВФорматеEMail = МетодСервера(,"ПолучитьСписокBoxIdАссоциированныхОрганизацийДиадок");
		
		Для Каждого BoxIdВФорматеEMail Из МассивBoxIdВФорматеEMail Цикл
			BoxId = Метрика_BoxIdВФорматеGUID(BoxIdВФорматеEMail);
	...
	&НаКлиенте
	Функция Метрика_BoxIdВФорматеGUID(BoxIdВФорматеEMail)
		
		Результат = "";
		
		Data1 = Сред(BoxIdВФорматеEMail, 1, 8);
		Data2 = Сред(BoxIdВФорматеEMail, 9, 4);
		Data3 = Сред(BoxIdВФорматеEMail, 13, 4);
		Data4 = Сред(BoxIdВФорматеEMail, 17, 4);
		Data5 = Сред(BoxIdВФорматеEMail, 21, 12);
		
		Результат = ПодставитьПараметрыВСтроку("%1-%2-%3-%4-%5", Data1, Data2, Data3, Data4, Data5);
	...
	&НаКлиенте
	Процедура Метрика_ДобавитьСтатистику_НажалиКнопкуСкачатьОбновление(ТекущаяВерсия, НоваяВерсия) Экспорт
		...
		Переменные.Вставить("BoxId", МассивBoxId);
		Переменные.Вставить("НоваяВерсия", НоваяВерсия);
		Переменные.Вставить("ТекущаяВерсия", ТекущаяВерсия);
	...
	&НаКлиенте
	Функция Метрика_НастроенныеBoxId()
		
		Результат = Новый Массив;
		
		Для Каждого ЭлементКонтекста Из Платформа.ПараметрыКлиент.КонтекстДиадока Цикл
			
			Результат.Добавить(ЭлементКонтекста.Box.Guid);
...
#Область Базовые_методы_регистрации
	...
	// Записывает событие метрики в указанный топик без учета
	//  значения константы ДиадокОтключитьСборСтатистики  
	//
	// Параметры:
	//  Топик  	   - Строка - топик события;
	//  Категория  - Строка - категория события;
	//  Действие   - Строка - выполняемое действие;
	//  Место      - Строка - место возникновения события;
	//  Событие    - Строка - описание события;
	...
	// 
	&НаКлиенте
	Процедура Метрика_ЗаписатьПроизвольноеСобытие_Принудительно(Топик, Категория, Действие
		, Место		 = Неопределено
		, Событие	 = Неопределено
		, Переменные = Неопределено
		, ДобавитьСистемнуюИнформацию = Истина
		...
		ЗарегистрироватьСобытиеМетрики(Топик, СобытиеМетрики, TraceID, Переменные, ДобавитьСистемнуюИнформацию);
...
#Область Отправка_накопленных_событий_метрики
	...
	// Отправляет все накопленные события сервера в сервис Контур.Метрика
	// и очищает стек событий без учета значения константы ДиадокОтключитьСборСтатистики
	//
	&НаКлиенте
	...
	//
	&НаКлиенте
	Функция Метрика_ОтправитьСтекСобытий(СтекСобытий)
	...
	Процедура ОтправитьСобытияМетрики(События, Топик)
		...
		Если МожноОтправитьСобытияМетрикиЧерезКомпоненту() Тогда
			ОтправитьСобытияМетрикиЧерезКомпоненту(События, Топик);		
		Иначе
			ОтправитьСобытияМетрикиЧерезHTTPСоединение(События, Топик)	
		КонецЕсли;
		
	КонецПроцедуры
	
	&НаКлиенте
	Функция МожноОтправитьСобытияМетрикиЧерезКомпоненту()
		
		Результат = Ложь;
		
		Если УстановленоСоединениеСДиадокомЧерезКомпоненту() Тогда
			Результат = Истина;
		КонецЕсли;
	...
	&НаКлиенте
	Функция ОтправитьСобытияМетрикиЧерезКомпоненту(События, Топик)
		...
		ТелоЗапроса = ЗначениеВСтрокуJSON(ОтправляемыеСобытия, ПараметрыЗаписиJSON);
	...
	&НаКлиенте
	Функция ОтправитьСобытияМетрикиЧерезHTTPСоединение(События, Топик)
		
		ПараметрыСервиса = ОбщиеПараметрыHTTPСервиса();
		ПараметрыЗапроса = НовыеПараметрыHTTPЗапроса();
		
		ПараметрыСервиса.АдресВебСервиса = ПараметрыСервиса_Контур().АдресВебСервиса;
		...
		ПараметрыЗапроса.АдресМетода = АдресМетодаМетрики(Топик);
...
Функция АдресаИнтернетРесурсов() Экспорт
	...
	Результат.Вставить("СервисОбновлений",						 Объект.ПараметрыКлиентСервер.ПараметрыОкружения.АдресСервисаОбновлений);
	...
	Результат.Вставить("Инструкция_ОбновлениеМодуляВручную", 	 "https://wiki.diadoc.ru/pages/viewpage.action?pageId=12877977");
	Результат.Вставить("Инструкция_ОбновлениеИОписаниеВерсий", 	 "https://wiki.diadoc.ru/plugins/viewsource/viewpagesrc.action?pageId=12877897");
	Результат.Вставить("Инструкция_ОписаниеВерсий", 	 		 "https://wiki.diadoc.ru/plugins/viewsource/viewpagesrc.action?pageId=7668701");
